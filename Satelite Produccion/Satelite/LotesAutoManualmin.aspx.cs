...
namespace Satelite
{
    public partial class LotesAutoManualmin : System.Web.UI.Page
    {
        ...
        protected void PrintCurrentPage(object sender, EventArgs e)
        {
            ...
            //cont = (ContentPlaceHolder)Master.FindControl("ContentPlaceHolder1");
            //HtmlGenericControl li = (HtmlGenericControl)cont.FindControl("Pag1");
            Panel div = (Panel)FindControl("pnlContentsPaletAlv");
        ...
        private void Campos_ordenados()
        {
            ...
            //DrCodeQR.Items.Clear();
            //DrCodeQR.Items.Insert(0, new ListItem("QrCoder", "1"));
            //DrCodeQR.Items.Insert(1, new ListItem("Zxing", "2"));

            //DrCodeQR1.Items.AddRange(DrCodeQR.Items.OfType<ListItem>().ToArray());
            //DrCodeQR2.Items.AddRange(DrCodeQR.Items.OfType<ListItem>().ToArray());
            //DrCodeQR3.Items.AddRange(DrCodeQR.Items.OfType<ListItem>().ToArray());
            //DrCodeQR.SelectedIndex = 0;
            //DrCodeQR1.SelectedIndex = 0;
            //DrCodeQR2.SelectedIndex = 0;
            //DrCodeQR3.SelectedIndex = 0;
        }
        ...
        private void Carga_Lotes(string ID)
        {
            ...
            {
                string SQL = "";
                if (Imageprocesa1.Visible == true) //Los cerrados y procesados 
                {
                ...
                if (Imageprocesa2.Visible == false)
                {
                    LbDuplicados.Text = "";
        ...
        protected void btnPorcesa_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //        LbDateFT.Text = DateTime.Now.ToString("HH:mm:ss"); //fila["SendTime"].ToString().Substring(10);
                //        LbDateContents.Text = DateTime.Now.ToString("HH:mm:ss"); //fila["SendTime"].ToString().Substring(10);
                //        LbDateQR.Text = DateTime.Now.ToString("HH:mm:ss"); //fila["SendTime"].ToString().Substring(10);
                //        LbDatePaletAlv.Text = DateTime.Now.ToString("HH:mm:ss"); //fila["SendTime"].ToString().Substring(10);
                ...
                //                //mensaje
                //                Lbmensaje.Text = "No se encuentra la Variedad " + fila["TIPO_PLANTA"].ToString() + " para relacionar el campo ZDESCRIPTIPO con TIPO_PLANTA en la tabla ZTIPOPLANTADESCRIP.";
                //                cuestion.Visible = false;
                //                Asume.Visible = true;
                //                DvPreparado.Visible = true;
                //            }
                ...
                //            string N = "";
                //            SQL = "SELECT TOP 1 (ZDESCRIPCION) FROM  ZEMPRESAVARIEDAD  WHERE ZVARIEDAD ='" + fila["VARIEDAD"].ToString() + "'";
                ...
                //                //mensaje
                //                Lbmensaje.Text = "No se encuentra la Variedad " + fila["VARIEDAD"].ToString() + " para relacionar el campo ZDESCRIPCION con VARIEDAD en la tabla ZEMPRESAVARIEDAD.";
                //                cuestion.Visible = false;
                //                Asume.Visible = true;
                //                DvPreparado.Visible = true;
                //            }
                ...
                //            SQL = "SELECT TOP 1 (ZEMPRESA) FROM  ZEMPRESAVARIEDAD  WHERE ZVARIEDAD ='" + fila["VARIEDAD"].ToString() + "'";
                ...
                //                LbCodePaletAlv.Text = "";
                //                //mensaje
                //                Lbmensaje.Text = "No se encuentra la Variedad " + fila["VARIEDAD"].ToString() + " para relacionar el campo ZEMPRESA con VARIEDAD en la tabla ZEMPRESAVARIEDAD.";
                //                cuestion.Visible = false;
                //                Asume.Visible = true;
                //                DvPreparado.Visible = true;
                //            }
                ...
                //                //Consulta a ZPLANTA_TIPO_VARIEDAD_CODGOLDEN para ver si hay algo en el campo UD_BASE, con un join a ZBANDEJAS muestra 575 grupos de dos

                //                Con = DBHelper.ExecuteScalarSQL("SELECT TOP 1 (UD_BASE) FROM  ZPLANTA_TIPO_VARIEDAD_CODGOLDEN  WHERE ZTIPO_PLANTA ='" + fila["TIPO_PLANTA"].ToString() + "' AND UD_BASE IN NOT NULLL AND UD_BASE <> '' ", null);
                ...
                //                        if (Unidad_Base != "")
                //                        {
                //                            if (fila["UNIDADES"].ToString() != Unidad_Base)
                //                            {
                //                                string Cuantos = Convert.ToInt32(fila["NUM_UNIDADES"].ToString()).ToString();
                ...
                if (DrPrinters.SelectedItem.Value == "6")
                {
                    ...
                    if (TxtCajas.Text != "PLANTAS")
                    {
                        if (Unidad_Base != "")
                        {
                            ...
                            {
                                lbNumPlantasP.Text = "Cantidad: " + Convert.ToInt32(filas["NUM_UNIDADES"].ToString()) / 1000 + " " + Unidad_Base;
                            }
                            else
                            {
                                    ...
                                    if (DrPrinters.SelectedItem.Value == "6")
                                    {
                                        if (Unidad_Base != "")
                                        {
                                            if (filas["UNIDADES"].ToString() != Unidad_Base)
                                            {
                                                ...
                                                if (filas["UNIDADES"].ToString() == "GRAMOS")
                                                {
                                                    lbNumPlantasP.Text = "Cantidad: " + Convert.ToInt32(Cuantos) / 1000 + " " + Unidad_Base;
                                                }
                                                else
                                                {
                                                    lbNumPlantasP.Text = "Cantidad: " + Cuantos + " " + Unidad_Base;
