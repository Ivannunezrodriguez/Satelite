<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="InsertRegistros.aspx.cs" Inherits="Satelite.InsertRegistros" %>
                  ...
                  <br />
                    <div class="row">
                            <div class="col-lg-2" style="text-align:right">
                                <asp:Label  Font-Bold="true" type="text" runat="server" ID="Label10" Text="Tablas de Validación:"> </asp:Label>
                            </div>
                            <div class="col-lg-4">
                        ...
                        <div class="col-lg-4" >
                            <div class="panel panel-default" style="height:530px;">
                               <div class="panel-heading">
                                    <div class="row">
                                        <div class="col-lg-12" >
                                            <asp:Label CssClass="cajaslabel" type="text" runat="server" ID="lbTable" Width="80%" style="font-size:18px; font-weight: bold;"   Text="Tabla de Validación:"> </asp:Label>
                                        </div>
                                    </div>
                                </div>

								<div class="panel-body" visible="false" runat="server" id="DivFicheros">
									<div class="panel" style="height:400px;" visible="true" runat="server" id="DivFiles">
                                ...
                                <div class="panel-body" runat="server" id="DivCampoIzq">
                                    ...
                                    <div class="panel" style="height:400px;" visible="true" runat="server" id="DivPanelFlujo">
                                        ...
                                        <asp:Label CssClass="cajaslabel" runat="server" ID="Label1"  Width="100%"  Text="Campo Documental asociado:"> </asp:Label>
                        ...
                        <div class="col-lg-8"  style="height:510px;">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        <div class="col-lg-12" >
                                            <asp:Label CssClass="cajaslabel" type="text" runat="server" ID="Label20" Width="80%" style="font-size:18px; font-weight: bold;"   Text="Registro actual de este Archivo Documental"> </asp:Label>
                                        </div>
                                    </div>
                                </div>
                                <%--Div General de la derecha--%>
                                <div class="panel-body" visible="true" runat="server" id="DivCampoDer">   
                                    <div class="panel" visible="true" style="height:400px; overflow:auto;" runat="server" id="DivEstados">
                                       <%--<div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2">
                                             ...
                                             <div class="col-lg-2">
												 <asp:Button runat="server" Enabled="false" ID="BtCancela" Visible="true" CssClass="btn btn-warning btn-block" Width="100%" Text="Cancelar" OnClick="btCancela_Click"/>
                                            </div>
