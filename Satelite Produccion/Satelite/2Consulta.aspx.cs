...
namespace Satelite
{
    public partial class Consulta : System.Web.UI.Page
    {
        ...
        protected void CierraRegistro_Click(object sender, EventArgs e)
        {
            ...
            MisMenus.Visible = false;
            BMenu0.Visible = false;
        ...
        public void Carga_Menus()
        {
            ...
            if (this.Session["Menu"].ToString() == "0")
            {
                ...
                li.Attributes["class"] = "";                
                panel = (HtmlGenericControl)cont.FindControl("BMenu0");
                panel.Attributes["class"] = "tab-pane fade active in";
                panel = (HtmlGenericControl)cont.FindControl("BMenu1");
                panel.Attributes["class"] = "tab-pane fade";
                panel = (HtmlGenericControl)cont.FindControl("BMenu2");
                panel.Attributes["class"] = "tab-pane fade";
                ...
                foreach (TableCell tc in e.Row.Cells)
                {
                    if (tc.HasControls())
                    {
                        ...
                        if (lnk != null && grd.SortExpression == lnk.CommandArgument)
                        {
                            ...
                            this.SortDirection = this.SortDirection == "ASC" ? "DESC" : "ASC";
                            img.ImageUrl = "~/images/" + (this.SortDirection.ToLower()) + ".png";
        ...
        private void CreaGridMiControl(DataTable dtArchivo, DataTable dtCampo)
        {
            ...
            //foreach (DataRow fila in dtCampo.Rows)
            //{
            //    if (fila["ZID"].ToString() == dr["ZID_CAMPO"].ToString())
            //    {
            //    }
