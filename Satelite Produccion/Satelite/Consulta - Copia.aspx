...
<%--									<div class="row" runat="server" id="DivUpFile" visible="true" style="width:100%; height:180px; text-align:left;" >
					...
					<div class="row" id="DivUpload" visible="false" runat="server">
						...
						<div class="col-lg-1" style="text-align:right;">
							<asp:Label runat="server" class="alert alert-grey" ID="Label4" visible="false" BorderStyle="None" border="0" Width="65%" Text="Jerarquía:"  />
						...
						<div class="col-lg-1" style="text-align:left;"> 
							...
							<%--<button id="Button1" type="button" runat="server" visible="false" style=" text-align:right; border-style:none; width:25px; height:30px; background-color:transparent;" class="pull-center text-muted "  onserverClick="btnCloseFiles_Click"><i title="Documentos asociados a este registro" class="fa fa-sort-amount-asc fa-2x"></i></button>--%>
                        ...
                        <div class="col-lg-2" style="text-align:right;">
							<asp:Label runat="server" Visible="false" class="alert alert-grey" ID="Label3" BorderStyle="None" border="0" Width="100%" Text="Categoría:"  />
						</div>
                        <div class="col-lg-2" style="text-align:right;"> 
