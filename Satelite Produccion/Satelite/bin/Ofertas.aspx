<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Ofertas.aspx.cs" Inherits="Satelite.Ofertas" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <asp:UpdateProgress ID="Progress3" runat="server" AssociatedUpdatePanelID="UpdatePanel3">
                <ProgressTemplate>
                    <div class="centrado position-fixed" style="z-index:2100;position: fixed;">
            ...
            <div class="row" >
                <div class="col-lg-12"  >
                    ...
                    <ul class="nav nav-tabs" style="margin-bottom: 15px;" >
                        <li id="Menu0" class="active" runat="server" ><asp:LinkButton ID="aMenu0" runat="server" OnClick="HtmlAnchor_Click" >GENERACIÓN DE DOCUMENTACIÓN PARA OFERTAS CLIENTE</asp:LinkButton></li>                        
                ...
                <div class="panel-heading" runat="server" id="PanelFiltro" >
                    <div class="row">
                            ...
                            <h4 class="panel-title">
                                <a data-toggle="collapse" style=" font-weight: bold;"> Recogida muestra datos desde GoldenSoft (Rango mensual)
...
<%--                                <div class="row" runat="server" id="DivGralConsulta">                                                                       
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-1" style="text-align:center;">
                                    <%--<a class="navbar-brand" style="float: right;" href="./Setup/Firma.htm"> <img src="images/7856064.png" Width="40px" Height="40px" alt="Setup aplicación SignEresma" /></a>--%>
...
<%--                                <div class="col-sm-1" >
                                ...
                                <div class="col-sm-1" >                              
                                 ...
                                 <div class="col-lg-1" >
                                     <asp:Label  type="text"  Width="85%" style=" font-weight: bold;text-align:right; padding:6px;"  runat="server" ID="Label6"  Text="Ajustar Filas:" > </asp:Label>
                                   <asp:CheckBox ID="chkb1" ToolTip="Ajustar tamaño." name="Ajustar tamaño filas" runat="server" OnCheckedChanged="SelectAll" AutoPostBack="true" />
                                 </div>
                                <div class="col-sm-4" >
                                </div>
                            ...
                            <ContentTemplate>
                                    <div id="Div1" runat="server"   class="panel-body"> <%-- AutoGenerateSelectButton="True"--%> 
                                        <%--Automatico--%>
                                        <asp:GridView ID="gvEmpleado"  runat="server" AutoGenerateColumns="False" class="table table-striped table-bordered table-condensed table-responsive table-hover NoWrapRows" 
                                            ...
                                            OnRowDeleting="gvEmpleado_RowDeleting" onpageindexchanging="gvEmpleado_PageIndexChanging" AutoSizeColumnsMode="none" >
                                        <RowStyle />                     
                                            <Columns>
