<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="Satelite.Menu" %>
...
<%--                    <div class="row">
                        ...
                        <div class="row">
                             ...
                             <div class="col-lg-1" style="text-align:right">
                                   <asp:Label  Font-Bold="true" type="text" runat="server" ID="Label18" ToolTip="Menús definidos en la estructura documental para usuarios"   Text="Menús:"> </asp:Label>
                            </div>
                            <div class="col-lg-2">
                            ...
                            <div class="col-lg-3">
                                 <asp:ImageButton ID="ImageCopiaFlujo" Enabled="false" runat="server" ImageUrl="~/Images/copiar35x30Black.png" OnClick="btnCopiaFlujo_Click" ToolTip="Copia el Menú en pantalla y lo presenta pendiente de guardado" Width="30px" Height="30px"></asp:ImageButton>
                                 <asp:ImageButton ID="IbtCreaFlujo" Enabled="true" runat="server" ImageUrl="~/Images/newdoc35x30.png" OnClick="btnCreaFlujo_Click" ToolTip="Crear un nuevo Menú" Width="25px" Height="30px"></asp:ImageButton>
                                 <asp:ImageButton ID="ibtEditFlujo" Enabled="false" runat="server" ImageUrl="~/Images/editdoc35x30Black.png" OnClick="btnEditFlujo_Click" ToolTip="Edita el Menú seleccionado" Width="25px" Height="30px"></asp:ImageButton>
                                 <asp:ImageButton ID="ibtDeleteFlujo" Enabled="false" runat="server" ImageUrl="~/Images/elimina35x30Black.png" OnClick="btnDeleteFMenu_Click" ToolTip="Elimina el Menú seleccionado" Width="30px" Height="30px"></asp:ImageButton>
                               <%-- <asp:Button runat="server" Enabled="false" ID="BtCopiaFlujo" Visible="true" CssClass="btn btn-success btn-block" Width="25px" Height="30px" ToolTip="Copia el Menú en pantalla y lo presenta pendiente de guardado" Text="" OnClick="btnCopiaFlujo_Click"/> 
                                <asp:ImageButton ID="IbtAllFlujo"  runat="server" ImageUrl="~/Images/allwhite.png" OnClick="btnAllFlujo_Click" ToolTip="Muestra todos los Menús en la lista de selección" Width="30px" Height="30px"></asp:ImageButton>
                                <asp:Button CssClass="tamB" enabled="false" runat="server" id="BCopiaFlujo" onServerClick="btnCopiaFlujo_Click"/>     
                                <asp:Button CssClass="temB" enabled="false" runat="server" id="BCreaFlujo" onServerClick="btnCreaFlujo_Click"/>     
                                <asp:Button CssClass="timB" enabled="false" runat="server" id="BEditFlujo" onServerClick="btnEditFlujo_Click"/>     
                                <asp:Button CssClass="tomB" enabled="false" runat="server" id="BDeleteFlujo" onServerClick="btnDeleteFlujo_Click"/>     --%>
                            </div>

                            <div class="col-lg-1" style="text-align:right">
                                <asp:Label  Font-Bold="true" type="text" runat="server" ID="Label12"  ToolTip="Seleccione un Grupo para ver menus asociados" Text="Grupo Usuarios:"> </asp:Label>
                            </div>
                            <div class="col-lg-2">
                                <%--<asp:DropDownList runat="server" CssClass="form-control" ID="DrEstado" OnSelectedIndexChanged="DrEstado_SelectedIndexChanged" AppendDataBoundItems="true" AutoPostBack="True" Font-Bold="True" />--%>
                                  <asp:DropDownList runat="server" Enabled="true" CssClass="form-control" ID="Drsiguiente" Width="100%"  OnSelectedIndexChanged="drsiguiente_SelectedIndexChanged" AppendDataBoundItems="true" AutoPostBack="True" />    

                            </div>
                            <div class="col-lg-3" >
                                <%-- <asp:ImageButton ID="ImageCopiaEstado"  runat="server" ImageUrl="~/Images/copiar.png" OnClick="btnCopiaEstado_Click" ToolTip="Crear un nuevo Submenú" Width="30px" Height="30px"></asp:ImageButton>
                                 <asp:ImageButton ID="ibtCreaEstado"  runat="server" ImageUrl="~/Images/newdoc.png" OnClick="btnCreaEstado_Click" ToolTip="Crear un nuevo Submenú" Width="25px" Height="30px"></asp:ImageButton>--%>
                                 <asp:ImageButton ID="ibtEditEstado" Enabled="false" runat="server"  ImageUrl="~/Images/editdoc35x30Black.png" OnClick="btnEditEstado_Click" ToolTip="Edita el menú asociado al Grupo seleccionado" Width="25px" Height="30px"></asp:ImageButton>
                                 <asp:ImageButton ID="ibtDeleteEstado" Enabled="false" runat="server" ImageUrl="~/Images/elimina35x30Black.png" OnClick="btnDeleteMenu_Click" ToolTip="Elimina el menú asociado al Grupo seleccionado" Width="30px" Height="30px"></asp:ImageButton>
                                <%-- <asp:ImageButton ID="IbtAllEstado"  runat="server" ImageUrl="~/Images/allwhite.png" OnClick="btnAllEstado_Click" ToolTip="Muestra todos los menús en la lista de selección" Width="30px" Height="30px"></asp:ImageButton>--%>
                        ...
                        <div class="col-lg-6" >
                            <div class="panel panel-default" style="height:500px;">
                               <div class="panel-heading">
                                    <div class="row">
                                        <div class="col-lg-12" >
                                            <asp:Label CssClass="cajaslabel" type="text" runat="server" ID="Label19" Width="80%" style="font-size:18px; font-weight: bold;"   Text="Menús para usuarios:"> </asp:Label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel-body" runat="server" id="DivCampoIzq">
                                    <%--Menus:--%>
                                    <div class="panel" style="height:340px;" visible="true" runat="server" id="DivPanelFlujo">
                                        <asp:Label CssClass="cajaslabel" type="text" runat="server" ID="LblIDArchivo" Width="100%"   Text="Identificador:"> </asp:Label>
                                        <asp:TextBox type="text" Enabled="false" CssClass="form-control" runat="server" ID="TextID" Width="100%"  Height="35px"  ></asp:TextBox>
                                        <asp:Label CssClass="cajaslabel" type="text" runat="server" ID="Lnnombre" Width="100%"   Text="Nombre:"> </asp:Label>
                                        ...
                                        <asp:Label CssClass="cajaslabel" runat="server" ID="Label1"  Width="100%"  Text="Dependiente de Menú en jerarquía:"> </asp:Label>
                                        ...
                                        <asp:Label CssClass="cajaslabel" runat="server" ID="Label5" Width="100%"   Text="Página Web:"> </asp:Label>
                                        <asp:TextBox runat="server" Enabled="false" CssClass="form-control" ID="TxtPagW" Width="100%"  ></asp:TextBox>                                             
                                    ...
                                    <%--<div class="panel" visible="false" style="height: 400px;" runat="server" id="DivProfiles">
                                        <div class="panel" visible="true" runat="server" id="DvProfile">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <asp:Label CssClass="cajaslabel" type="text" runat="server" ID="Label63" Width="100%" Text="Submenú:"> </asp:Label>
                        ...
                        <div class="col-lg-6"  style="height:500px;">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        <div class="col-lg-6" >
                                            <asp:Label CssClass="cajaslabel" style=" font-size:18px; font-weight:bold;" runat="server" ID="Label6" Width="100%"   Text="Grupo usuarios:"> </asp:Label>
                                        </div>
                                        <div class="col-lg-6" >
                                        </div>
                                    </div>
                                ...
                                <div class="panel-body" visible="true" style="height:450px; " runat="server" id="DivCampoDer">   
                                    <div class="panel" visible="true" style="height:340px; overflow-y: scroll;"  runat="server" id="DivEstados">
                                    </div>
                  ...
                  <div class="col-lg-5 col-md-6" >
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="row" >
                                    <div class="col-lg-11" >
                                        <asp:Label CssClass="cajaslabel" type="text" runat="server" ID="Label14" Width="80%" style="font-size:18px; font-weight: bold;"  Text="Menús Disponibles:"> </asp:Label>
                                    </div>
                                    <div class="col-lg-1" >
                                        <asp:Label CssClass="cajaslabel" type="text" runat="server" ID="LbDisponible" Width="100%" style="font-size:18px; font-weight: bold;"  Text="0"> </asp:Label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-2 col-md-6" >
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                              <asp:Button ID="Button1" Enabled="false" CssClass="btn btn-success btn-block"  runat="server" Text="Asignar Menús >>" ToolTip="Asigna el menú seleccionado en lista de Disponibles a la lista de Seleccionados" OnClick="btnPasarSeleccionados_Click" />
                              <asp:Button ID="Button2" Enabled="false" CssClass="btn btn-success btn-block" runat="server" Text="<< Desasignar Menús" ToolTip="Devuelve el menú seleccionado en lista de Seleccionados a la lista de Disponibles" OnClick="btnRegresarSeleccionados_Click" />

                              <asp:Button ID="Button4" Enabled="false" CssClass="btn btn-success btn-block" runat="server" Text="Limpiar" OnClick="btnLimpiar_Click" ToolTip="Limpia la lista de Seleccionados devolviendola a la lista de Disponibles" />
                              <asp:Button ID="Button5" Enabled="true" CssClass="btn btn-success btn-block"  runat="server" Text="Buscar" OnClick="btnBuscar_Click" ToolTip="Busca en todas las listas el texto escrito en la casilla de Busqueda" />
                                    <br />
                              <asp:TextBox ID="TextBox1" Width="100%" CssClass="form-control" placeholder="Buscar..." runat="server"></asp:TextBox>    
                                    <br />
                              <asp:Button ID="Button6" Enabled="false" CssClass="btn btn-success btn-block"   runat="server" Text="Subir" OnClick="Subir_Click" ToolTip="Sube el menú seleccionado una casilla en la lista de Seleccionados" />
                              <asp:Button ID="Button7" Enabled="false" CssClass="btn btn-success btn-block" runat="server"  Text="Bajar" OnClick="Bajar_Click" ToolTip="Baja el menú seleccionado una casilla en la lista de Seleccionados"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5 col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col-lg-12" >
                                        <div class="col-lg-3" >
                                            <asp:Label CssClass="cajaslabel" type="text" runat="server" ID="LbRelFlujo" Width="100%" style="font-size:18px; font-weight: bold;"  Text="Menús Asociados:"> </asp:Label>
                                        </div>
                                        <div class="col-lg-1" >
                                            <asp:Label CssClass="cajaslabel" type="text" runat="server" ID="LbAsociado" Width="100%" style="font-size:18px; font-weight: bold;"  Text="0"> </asp:Label>
                                        </div>
                                        <div class="col-lg-3" >
                                             <asp:Label CssClass="cajaslabel" type="text" runat="server" ID="Label3" Width="100%" style="font-size:18px; font-weight: bold;"  Text="Tiene Nivel:"> </asp:Label>
                                        </div>
                                        <div class="col-lg-1" >
                                            <asp:Label CssClass="cajaslabel" type="text" runat="server" ID="LbNivel" Width="100%" style="font-size:18px; font-weight: bold;"  Text="0"> </asp:Label>
                                        </div>
                                        <div class="col-lg-1" >
                                            <asp:CheckBox ID="chkb1" ToolTip="Todos con el mismo permiso seleccionado." runat="server" OnCheckedChanged="sellectAll" AutoPostBack="true" />
                                        </div>
                                        <div class="col-lg-2" >
                                            <asp:DropDownList runat="server" Enabled="false" CssClass="form-control" ID="DrNiveles" Width="100%" OnSelectedIndexChanged="DrNiveles_SelectedIndexChanged" AppendDataBoundItems="true" AutoPostBack="True" />
                                        </div>
                                        <div class="col-lg-1" >
                                            <asp:ImageButton ID="IbtAllFlujo"  runat="server" ImageUrl="~/Images/descarga.png" OnClick="btnAllMenu_Click" ToolTip="Inserta nivel de seguridad en Menú seleccionado" Width="30px" Height="30px"></asp:ImageButton>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                  <div class="col-lg-8" >
                                    ...
                                    <div class="col-lg-2" >
                                        <asp:ListBox ID="ListBoxNivel" style="height:300px;width:100%" AutoPostBack="true" CssClass="form-control" runat="server" OnSelectedIndexChanged="ListBoxNivel_SelectedIndexChanged" SelectionMode="Multiple"></asp:ListBox>
                                    </div>
                                   <div class="col-lg-2" >
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                     ...
                     <div class="panel-body" visible="true" runat="server" id="Div1">                        
                            ...
                            <asp:TextBox ID="TxtZQuery"  Width="100%" Height="100%"  TextMode="MultiLine" Columns="50" Rows="6" runat="server"/>
