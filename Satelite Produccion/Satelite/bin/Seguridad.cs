...
namespace Satelite
{
    public static class Seguridad
    {
        ...
        //ejemplo Clave:                 1290-E48E-B887-B0F8-E786-E002-A9F6-25E4 se meterá a pelo para pruebas, en producción deberá generarse tras la instalación con Mandragora.
        public static string ClKyClone = "random del hardware del equipo"; // Clave de cifrado temporal del usuario. NOTA: Puede ser cualquier combinación de carácteres. Cada usuario lleva su ID hardware en el EXE
        public static string Clave = "1290-E48E-B887-B0F8-E786-E002-A9F6-25E4"; // Clave de cifrado temporal del servidor para ese random del hardware del equipo.
                                                                                // NOTA: Puede ser cualquier combinación de carácteres. Cada usuario lleva su ID hardware en el EXE
        ...
        // El usuario deberá entender que si le falta una de esas llaves no se podrá leer la información que contenga.
