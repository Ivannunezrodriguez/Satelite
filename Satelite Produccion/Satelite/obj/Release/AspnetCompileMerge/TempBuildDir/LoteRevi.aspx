<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoteRevi.aspx.cs" Inherits="QRCode_Demo.LoteRevi" MaintainScrollPositionOnPostback="true" %>
                    ...
                    <div class="col-lg-5">
                        <div class="panel panel-default">
                            <div class="panel-heading">                    
                             ...
                             <button id="btnRestoreTodo" type="button" visible="false" runat="server" class="pull-right text-muted "  onserverClick="btnRestoreTodo_Click"><i title="El tipo de Formulario seleccionado se restaura al completo a su estado anterior, de finalizado a procesado" class="fa fa-undo"></i></button>
                           ...
                           <div class="panel-body">
                               <div class="col-lg-12" >
                                   ...
                                   <label runat="server" visible="false" tooltip="Muestra los enviados a GoldenSoft" id="LBCheck" class="switch pull-right">
                              ...
                              <%-- <div class="col-lg-2" >
                               ...
                               <div class="col-lg-12" >
                                ...
                                <asp:Label ID="txtQRCodebis" Visible="false" style="text-align:center; color:red; font-size:18px; font-weight: bold;" runat="server" Width="100%" CssClass="form-control" ></asp:Label>
                                ...
                                <%--<asp:Button runat="server" ID="BtnLanzaPro" tooltip="Inserta en la Tabla de GlodenSoft para importar" CssClass="btn btn-success btn-block" Width="100%"  Text="Lanza procedimiento" OnClick="BtnLanzaPro_Click"/>--%>
                                   ...
                                   <br />
                                       <div class="col-lg-4" >
                                           <asp:Button runat="server" ID="BtFinalizalote" Visible="true" tooltip="Finaliza sólo este Lote del formulario seleccionado" CssClass="btn btn-success btn-block" Width="100%"  Text="Finaliza este Lote" OnClick="BtFinalizalote_Click"/>                              
                                        </div>
                                       <div class="col-lg-4" >
                                           <asp:Button runat="server" ID="BtFinalizaTodos" Visible="true" tooltip="Finaliza todos los Lotes de formulario en su lista 'Códigos QR recibidos / finalizados'" CssClass="btn btn-warning btn-block" Width="100%"  Text="Finalizar todos" OnClick="BtFinalizaTodos_Click"/>                              
                                        </div>
                                       <div class="col-lg-4" >
                                           <asp:Button runat="server" ID="BtEnviaFinalizados" Visible="true" tooltip="Envia todos los Lotes finalizados seleccionados del formulario en su lista 'Códigos QR recibidos / finalizados' a GoldenSoft" CssClass="btn btn-Procesado btn-block" Width="100%"  Text="Enviar todos los Lotes" OnClick="BtEnviaFinalizados_Click"/>                              
                                        </div>
                               </div>
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i> Seleccionar código lote. Existen Duplicados:
                           ...
                           <div class="panel-body">
                               ...
                               <div class="col-lg-12" >
                                <asp:Label  type="text" Width="100%" style=" font-weight: bold;"  runat="server" ID="lbBuscaCod"  Text="Códigos QR recibidos / finalizados:" > </asp:Label>
                                   ...
                                   <asp:DropDownList runat="server" CssClass="form-control"  Width="100%"  tooltip="Contiene los código QR con o sin Formulario de Scan-IT, además de los finalizados" ID="DrLotes"  OnSelectedIndexChanged="DrLotes_SelectedIndexChanged" AppendDataBoundItems="true" AutoPostBack="True" Font-Bold="True" />
                                <%--<br />--%>
                                <%--<asp:Button runat="server" ID="BtnLanzaPro" Visible="false" tooltip="Inserta en la Tabla de GlodenSoft para importar" CssClass="btn btn-success btn-block" Width="100%"  Text="Envia a GoldenSoft" OnClick="BtnLanzaPro_Click"/>--%>                              
                               </div>
                               
                                <div class="col-lg-12" >
                                <asp:Label  type="text" Width="100%" style=" font-weight: bold;"  runat="server"  ID="Label2"  Text="Códigos QR creados / escaneados:" > </asp:Label>
                                
                                   <asp:DropDownList runat="server" CssClass="form-control"  Width="100%"  ID="DrScaneados" tooltip="Contiene los código QR pendientes de registro desde un Formulario de Scan-IT" OnSelectedIndexChanged="DrScaneados_SelectedIndexChanged" AppendDataBoundItems="true" AutoPostBack="True" Font-Bold="True" />
                                </div>
                               <div class="col-lg-6" > 
                        ...
                        <div class="panel panel-default">
                           ...
                           <div class="panel-body">
                               ...
                               <div class="col-lg-12" >
                                ...
                                <asp:Label  type="text" Width="100%" style=" font-weight: bold;"  runat="server" ID="Label9"  Text="Lote Destino:" > </asp:Label>
                                ...
                                <asp:Label  type="text"   Width="100%" style=" font-weight: bold;"  runat="server" ID="Label3"  Text="Estado:" > </asp:Label>
                                ...
                                <asp:Label  type="text"   Width="100%" style=" font-weight: bold;"  runat="server" ID="Label8"  Text="Dispositivo Móvil:" > </asp:Label>
                                ...
                                <br />
                                   <div class="col-lg-4" >
                                    ...
                                    <div class="col-lg-4" >
                                    <asp:Button runat="server" ID="BtCancelaLote" visible="true" tooltip="Cancela el código QR que tienes en edición en este momento" CssClass="btn btn-warning btn-block" Width="100%"  Text="Cancelar" OnClick="btnCancelaLote_Click"/>
                                    </div>
                                    <div class="col-lg-4" >
                                        <asp:Button runat="server" ID="BtDelete" Enabled="false" visible="true" tooltip="Marca como borrado el código QR seleccionado" CssClass="btn btn-success btn-block" Width="100%"  Text="Eliminar" OnClick="btnDelete_Click"/>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapseOne" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <br />
                                        <label>Alto:</label><asp:TextBox ID="TxAlto" runat="server" Text="300"  CssClass="form-control"></asp:TextBox>
                                        <label>Ancho:</label><asp:TextBox ID="TxAncho" runat="server" Text="300"  CssClass="form-control"></asp:TextBox>
                                        </div>
                                        <div class="col-lg-6" >
                                            <label>Código QR Total</label>
                                            <br />
                                            <label>Alto:</label><asp:TextBox ID="TxAltoT" runat="server" Text="200"  CssClass="form-control"></asp:TextBox>
                                            <label>Ancho:</label><asp:TextBox ID="TxAnchoT" runat="server" Text="200"  CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>         
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div id="H1Normal" runat="server" visible="true" class="panel-heading">
                                <h3 class="panel-title" style="color: black; font-weight:bold;"><i class="fa fa-long-arrow-right"></i> Seleccione un Lote                               
                                    ...
                                    <button id="btnPrintB1" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintQR();"><i title="Imprime la vista previa presentada en pantalla" class="fa fa-print"></i></button>   
                                    <button id="btnPrintC1" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintFT();"><i title="Imprime la vista previa presentada en pantalla" class="fa fa-print"></i></button>
                                    <button id="btnPrintD1" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintPaletAlv();"><i title="Imprime la vista previa presentada en pantalla" class="fa fa-print"></i></button>
                                </h3>                              
                            </div>    
                            <div id="H1Seleccion" runat="server" visible="false" class="panel-heading">
                                <h3 class="panel-title" style="color: black; font-weight:bold;"><i class="fa fa-long-arrow-right"></i> Lote con Código QR seleccionado
                                     <button id="btnPrintA2" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintPanel();"><i title="Imprime la vista previa presentada en pantalla" class="fa fa-print"></i></button>
                                    <button id="btnPrintB2" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintQR();"><i title="Imprime la vista previa presentada en pantalla" class="fa fa-print"></i></button>
                                    <button id="btnPrintC2" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintFT();"><i title="Imprime la vista previa presentada en pantalla" class="fa fa-print"></i></button>
                                    <button id="btnPrintD2" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintPaletAlv();"><i title="Imprime la vista previa presentada en pantalla" class="fa fa-print"></i></button>
                                </h3>                              
                            </div>    
                             <div id="H1Red" runat="server" visible="false" class="panel-heading">
                                <h3 class="panel-title" style="color: red; font-weight:bold;"><i class="fa fa-long-arrow-right"></i> Código QR YA ASIGNADO, PENDIENTE PROCESAR
                                    <button id="btnPrintA3" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintPanel();"><i title="Imprime la vista previa presentada en pantalla" class="fa fa-print"></i></button>
                                    <button id="btnPrintB3" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintQR();"><i title="Imprime la vista previa presentada en pantalla" class="fa fa-print"></i></button>
                                    <button id="btnPrintC3" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintFT();"><i title="Imprime la vista previa presentada en pantalla" class="fa fa-print"></i></button>
                                    <button id="btnPrintD3" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintPaletAlv();"><i title="Imprime la vista previa presentada en pantalla" class="fa fa-print"></i></button>
                                </h3>                              
                            </div>    
                             <div id="H1Green" runat="server" visible="false" class="panel-heading">
                                <h3 class="panel-title" style="color: LimeGreen; font-weight:bold;"><i class="fa fa-long-arrow-right"></i> Código QR PROCESADO
                                     <button id="btnPrintA4" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintPanel();"><i title="Imprime la vista previa presentada en pantalla" class="fa fa-print"></i></button>
                                    <button id="btnPrintB4" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintQR();"><i title="Imprime la vista previa presentada en pantalla" class="fa fa-print"></i></button>
                                    <button id="btnPrintC4" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintFT();"><i title="Imprime la vista previa presentada en pantalla" class="fa fa-print"></i></button>
                                    <button id="btnPrintD4" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintPaletAlv();"><i title="Imprime la vista previa presentada en pantalla" class="fa fa-print"></i></button>
                                </h3>                              
                            </div>  
                            ...
                            <div class="panel-body" style="height:900px;"> 
                                ...
                                <div class="col-lg-7" >
                                    ...
                                    <asp:Panel ID="pnlContentsPaletAlv" Visible="false" runat="server">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-2" alig="center">
                                            </div>
                                            <div class="col-lg-2" >
                                                
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:24px;"  runat="server" ID="LbCodeQRPalteAlv"  Text="SIN CÓDIGO LOTE" > </asp:Label>        
                                            </div>
                                            <div class="col-lg-8" alig="center">
                                    ...
                                    <asp:Panel ID="pnlContentsQR" Visible="false" runat="server">
                                        ...
                                        <div class="col-lg-6" style="text-align: center;" >
                                            ...
                                            <asp:Label  type="text" style=" font-weight: bold; font-size:18px;"  runat="server" ID="LbSecuenciaLoteQR"  Text="" > </asp:Label>
                                            <br />
