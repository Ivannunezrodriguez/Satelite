<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="importFiles.aspx.cs" Inherits="QRCode_Demo.importFiles" %>
...
<body>
    <form id="form1" style=" height:20px; "  runat="server">
       ...
       <%-- <h2><a href="http://www.yogihosting.com/multi-file-upload-with-progress-bar-in-asp-net/">Read the tutorial on YogiHosting »</a></h2>--%>
        <%--<div class="wrapper" style="width:100%;position:absolute;">--%>
        <label class="file-upload" style="width:45%; margin-top:2px;">
           <span><strong>Seleccionar Ficheros</strong></span>
            ...
            <input type="button" class="btn btn-default" style="width:50%;margin-top:-5px; " value="Subir ficheros" onclick="UploadFile()" />
            <progress id="progressBar" value="0" max="100" style="width:96%;text-align:right;"></progress>
            <h3 id="status"></h3>
