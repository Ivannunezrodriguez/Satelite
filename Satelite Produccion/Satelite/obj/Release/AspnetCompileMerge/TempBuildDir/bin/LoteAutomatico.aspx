<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoteAutomatico.aspx.cs" Inherits="QRCode_Demo.LoteAutomatico" MaintainScrollPositionOnPostback="true" %>
...
<body>
                    ...
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <%--<li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="RecoNomina.aspx"><i class="fa fa-long-arrow-right"></i> Nominas de Recodat</a>
                                    </li>                               
                                </ul>
                            </li> --%>
                        </ul>
                        ...
                        <div class="col-lg-5">
                            <div class="panel panel-default">
                                <div class="panel-heading">                    
                                 <h3 class="panel-title" id="H3PanelTitle" runat="server" ><i class="fa fa-long-arrow-right"></i>Listas para la generación de QR
    ...
    <%--                                <asp:Label ID="txtQRCodebis" Visible="true" style="text-align:center; color:red; font-size:18px; font-weight: bold;" runat="server" Width="100%" CssClass="form-control" ></asp:Label>--%>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i>Formulario de entrada de datos desde Móvil
                                </h3>                              
                                </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <asp:Label  type="text"  style="font-size:14px;"  runat="server" ID="lbtitleLote"  Text="Seleccionar código lote. Existen Duplicados:" > </asp:Label>
...
<%--                            <div class="panel-group" id="accordion">
                        ...
                        <div class="col-lg-7" >
                            <div class="panel panel-default">
                               <%-- <div id="DVSeleccione" runat="server" visible="true" class="panel-heading">
                                    <h3 class="panel-title" id="H3Seleccione" runat="server" style="color: black; font-weight:bold;"><i class="fa fa-long-arrow-right"></i> Seleccione un Lote                               
                                        <button id="Btprt1" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintPanel();"><i title="Imprime la vista previa presentada en pantalla" class="fa fa-print"></i></button>
                                        <button id="Btprt2" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintQR();"><i title="Imprime la vista previa presentada en pantalla" class="fa fa-print"></i></button>   
                                        <button id="Btprt3" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintFT();"><i title="Imprime la vista previa presentada en pantalla" class="fa fa-print"></i></button>
                                        <button id="Btprt4" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintPaletAlv();"><i title="Imprime la vista previa presentada en pantalla" class="fa fa-print"></i></button>
                                    </h3>                              
                                </div>    --%>
                                ...
                                <div id="H1Normal" runat="server" visible="true" class="panel-heading">
                                    <h3 class="panel-title" style="color: black; font-weight:bold;"><i class="fa fa-long-arrow-right"></i> Seleccione un Lote                               
                                        <button id="btnPrintA1" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintPanel();"><i title="Imprime la vista previa presentada en pantalla PrintPanel()" class="fa fa-print"></i></button>
                                        <button id="btnPrintB1" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintQR();"><i title="Imprime la vista previa presentada en pantalla PrintQR()" class="fa fa-print"></i></button>   
                                        <button id="btnPrintC1" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintFT();"><i title="Imprime la vista previa presentada en pantalla PrintFT()" class="fa fa-print"></i></button>
                                        <button id="btnPrintD1" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintPaletAlv();"><i title="Imprime la vista previa presentada en pantalla PrintPaletAlv()" class="fa fa-print"></i></button>
                                    </h3>                              
                                </div>    
                                <div id="H1Seleccion" runat="server" visible="false" class="panel-heading">
                                    <h3 class="panel-title" style="color: black; font-weight:bold;"><i class="fa fa-long-arrow-right"></i> Lote con Código QR seleccionado
                                         <button id="btnPrintA2" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintPanel();"><i title="Imprime la vista previa presentada en pantalla PrintPanel()" class="fa fa-print"></i></button>
                                        <button id="btnPrintB2" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintQR();"><i title="Imprime la vista previa presentada en pantalla PrintQR()" class="fa fa-print"></i></button>
                                        <button id="btnPrintC2" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintFT();"><i title="Imprime la vista previa presentada en pantalla PrintFT()" class="fa fa-print"></i></button>
                                        <button id="btnPrintD2" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintPaletAlv();"><i title="Imprime la vista previa presentada en pantalla PrintPaletAlv()" class="fa fa-print"></i></button>
                                    </h3>                              
                                </div>    
                                 <div id="H1Red" runat="server" visible="false" class="panel-heading">
                                    <h3 class="panel-title" style="color: red; font-weight:bold;"><i class="fa fa-long-arrow-right"></i> Código QR YA ASIGNADO, PENDIENTE PROCESAR
                                        <button id="btnPrintA3" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintPanel();"><i title="Imprime la vista previa presentada en pantalla PrintPanel()" class="fa fa-print"></i></button>
                                        <button id="btnPrintB3" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintQR();"><i title="Imprime la vista previa presentada en pantalla PrintQR()" class="fa fa-print"></i></button>
                                        <button id="btnPrintC3" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintFT();"><i title="Imprime la vista previa presentada en pantalla PrintFT()" class="fa fa-print"></i></button>
                                        <button id="btnPrintD3" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintPaletAlv();"><i title="Imprime la vista previa presentada en pantalla PrintPaletAlv()" class="fa fa-print"></i></button>
                                    </h3>                              
                                </div>    
                                 <div id="H1Green" runat="server" visible="false" class="panel-heading">
                                    <h3 class="panel-title" style="color: LimeGreen; font-weight:bold;"><i class="fa fa-long-arrow-right"></i> Código QR PROCESADO
                                         <button id="btnPrintA4" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintPanel();"><i title="Imprime la vista previa presentada en pantalla PrintPanel()" class="fa fa-print"></i></button>
                                        <button id="btnPrintB4" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintQR();"><i title="Imprime la vista previa presentada en pantalla PrintQR()" class="fa fa-print"></i></button>
                                        <button id="btnPrintC4" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintFT();"><i title="Imprime la vista previa presentada en pantalla PrintFT()" class="fa fa-print"></i></button>
                                        <button id="btnPrintD4" type="button" runat="server" visible="false" class="pull-right text-muted "  onclick="return PrintPaletAlv();"><i title="Imprime la vista previa presentada en pantalla PrintPaletAlv()" class="fa fa-print"></i></button>
                                    </h3>                              
                                </div>  
                                <%--<Vistas de Impresora >--%>
                                <div class="panel-body" style="height:900px;" id="BodyQR" runat="server"> 
                                        ...
                                        <%--grid para impresora--%>
                                        <%--<div class="row" id="DVPrint1" visible="false" runat="server">
                                            <div class="col-lg-4" runat="server" visible="false" id="R1C0" >
                                                <asp:PlaceHolder ID="PlaceR1C0" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR1C0"  Text="" > </asp:Label>
                                            </div>
                                             <div class="col-lg-4" runat="server" visible="false" id="R1C1" >
                                                 <asp:PlaceHolder ID="PlaceR1C1" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR1C1"  Text="" > </asp:Label>
                                            </div>
                                             <div class="col-lg-4" runat="server" visible="false" id="R1C2" >
                                                 <asp:PlaceHolder ID="PlaceR1C2" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR1C2"  Text="" > </asp:Label>
                                            </div>
                                        </div>
                                        <div class="row" id="DVPrint2" visible="false" runat="server">
                                            <div class="col-lg-4" runat="server" visible="false" id="R2C0" >
                                                <asp:PlaceHolder ID="PlaceR2C0" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR2C0"  Text="" > </asp:Label>
                                            </div>
                                             <div class="col-lg-4" runat="server" visible="false" id="R2C1" >
                                                 <asp:PlaceHolder ID="PlaceR2C1" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR2C1"  Text="" > </asp:Label>
                                            </div>
                                             <div class="col-lg-4" runat="server" visible="false" id="R2C2" >
                                                 <asp:PlaceHolder ID="PlaceR2C2" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR2C2"  Text="" > </asp:Label>
                                            </div>
                                        </div>
                                        <div class="row" id="DVPrint3" visible="false" runat="server">
                                            <div class="col-lg-4" runat="server" visible="false" id="R3C0" >
                                                <asp:PlaceHolder ID="PlaceR3C0" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR3C0"  Text="" > </asp:Label>
                                            </div>
                                             <div class="col-lg-4" runat="server" visible="false" id="R3C1" >
                                                 <asp:PlaceHolder ID="PlaceR3C1" visible="false" runat="server"></asp:PlaceHolder>
                                                 <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:24px; text-align:left;"  runat="server" ID="lbR3C1"  Text="SIN CÓDIGO LOTE" ></asp:Label>                                   
                                             </div>
                                             <div class="col-lg-4" runat="server" visible="false" id="R3C2" >
                                                 <asp:PlaceHolder ID="PlaceR3C2" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR3C2"  Text="" > </asp:Label>
                                            </div>
                                        </div>
                                        <div class="row" id="DVPrin4" visible="false" runat="server">
                                            <div class="col-lg-4" runat="server" visible="false" id="R4C0" >
                                                <asp:PlaceHolder ID="PlaceR4C0" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR4C0"  Text="" > </asp:Label>
                                            </div>
                                             <div class="col-lg-4" runat="server" visible="false" id="R4C1" >
                                                 <asp:PlaceHolder ID="PlaceR4C1" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR4C1"  Text="" > </asp:Label>
                                            </div>
                                             <div class="col-lg-4" runat="server" visible="false" id="R4C2" >
                                                 <asp:PlaceHolder ID="PlaceR4C2" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR4C2"  Text="" > </asp:Label>
                                            </div>
                                        </div>
                                        <div class="row" id="DVPrint5" visible="false" runat="server">
                                            <div class="col-lg-4" runat="server" visible="false" id="R5C0" >
                                                <asp:PlaceHolder ID="PlaceR5C0" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR5C0"  Text="" > </asp:Label>
                                            </div>
                                             <div class="col-lg-4" runat="server" visible="false" id="R5C1" >
                                                 <asp:PlaceHolder ID="PlaceR5C1" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR5C1"  Text="" > </asp:Label>
                                            </div>
                                             <div class="col-lg-4" runat="server" visible="false" id="R5C2" >
                                                 <asp:PlaceHolder ID="PlaceR5C2" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR5C2"  Text="" > </asp:Label>
                                            </div>
                                        </div>
                                        <div class="row" id="DVPrint6" visible="false" runat="server">
                                            <div class="col-lg-4" runat="server" visible="false" id="R6C0" >
                                                <asp:PlaceHolder ID="PlaceR6C0" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR6C0"  Text="" > </asp:Label>
                                            </div>
                                             <div class="col-lg-4" runat="server" visible="false" id="R6C1" >
                                                 <asp:PlaceHolder ID="PlaceR6C1" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR6C1"  Text="" > </asp:Label>
                                            </div>
                                             <div class="col-lg-4" runat="server" visible="false" id="R6C2" >
                                                 <asp:PlaceHolder ID="PlaceR6C2" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR6C2"  Text="" > </asp:Label>
                                            </div>
                                        </div>
                                        <div class="row" id="DVPrint7" visible="false" runat="server">
                                            <div class="col-lg-4" runat="server" visible="false" id="R7C0" >
                                                <asp:PlaceHolder ID="PlaceR7C0" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR7C0"  Text="" > </asp:Label>
                                            </div>
                                             <div class="col-lg-4" runat="server" visible="false" id="R7C1" >
                                                 <asp:PlaceHolder ID="PlaceR7C1" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR7C1"  Text="" > </asp:Label>
                                            </div>
                                             <div class="col-lg-4" runat="server" visible="false" id="R7C2" >
                                                 <asp:PlaceHolder ID="PlaceR7C2" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR7C2"  Text="" > </asp:Label>
                                            </div>
                                        </div>
                                        <div class="row" id="DVPrint8" visible="false" runat="server">
                                            <div class="col-lg-4" runat="server" visible="false" id="R8C0" >
                                                <asp:PlaceHolder ID="PlaceR8C0" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR8C0"  Text="" > </asp:Label>
                                            </div>
                                             <div class="col-lg-4" runat="server" visible="false" id="R8C1" >
                                                 <asp:PlaceHolder ID="PlaceR8C1" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR8C1"  Text="" > </asp:Label>
                                            </div>
                                             <div class="col-lg-4" runat="server" visible="false" id="R8C2" >
                                                 <asp:PlaceHolder ID="PlaceR8C2" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR8C2"  Text="" > </asp:Label>
                                            </div>
                                        </div>
                                        <div class="row" id="DVPrint9" visible="false" runat="server">
                                            <div class="col-lg-4" runat="server" visible="false" id="R9C0" >
                                                <asp:PlaceHolder ID="PlaceR9C0" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR9C0"  Text="" > </asp:Label>
                                            </div>
                                             <div class="col-lg-4" runat="server" visible="false" id="R9C1" >
                                                 <asp:PlaceHolder ID="PlaceR9C1" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR9C1"  Text="" > </asp:Label>
                                            </div>
                                             <div class="col-lg-4" runat="server" visible="false" id="R9C2" >
                                                 <asp:PlaceHolder ID="PlaceR9C2" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR9C2"  Text="" > </asp:Label>
                                            </div>
                                        </div>
                                        <div class="row" id="DVPrint10" visible="false" runat="server">
                                            <div class="col-lg-4" runat="server" visible="false" id="R10C0" >
                                                <asp:PlaceHolder ID="PlaceR10C0" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR10C0"  Text="" > </asp:Label>
                                            </div>
                                             <div class="col-lg-4" runat="server" visible="false"  id="R10C1" >
                                                 <asp:PlaceHolder ID="PlaceR10C1" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR10C1"  Text="" > </asp:Label>
                                            </div>
                                             <div class="col-lg-4" runat="server" visible="false" id="R10C2" >
                                                 <asp:PlaceHolder ID="PlaceR10C2" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR10C2"  Text="" > </asp:Label>
                                            </div>
                                        </div>
                                    <div class="row" id="DVPrint11" visible="false" runat="server">
                                            <div class="col-lg-4" runat="server" visible="false" id="R11C0" >
                                                <asp:PlaceHolder ID="PlaceR11C0" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR11C0"  Text="" > </asp:Label>
                                            </div>
                                             <div class="col-lg-4" runat="server" visible="false" id="R11C1" >
                                                 <asp:PlaceHolder ID="PlaceR11C1" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR11C1"  Text="" > </asp:Label>
                                            </div>
                                             <div class="col-lg-4" runat="server" visible="false" id="R11C2" >
                                                 <asp:PlaceHolder ID="PlaceR11C02" visible="false" runat="server"></asp:PlaceHolder>
                                                <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;" visible="false" runat="server" ID="lbR11C2"  Text="" > </asp:Label>
                                            </div>
                                        </div>--%>
                                        <%--fin grid para impresora--%>
                                    ...
                                    <div class="col-lg-7" >
                                        ...
                                        <asp:Panel ID="pnlContentsQR" Visible="false" runat="server">
                                            ...
                                            <div class="col-lg-6" style="text-align: center;" >
                                                ...
                                                <asp:Label  type="text" style=" font-weight: bold; font-size:40px;"  runat="server" ID="LbSecuenciaLoteQR"  Text="" > </asp:Label>
                                                <br />
                                         ...
                                         <asp:Panel ID="pnlContentsPaletAlv" Visible="false" runat="server">
                                            <div class="row">
                                                <div class="col-lg-7" alig="left" >
                                                    <br />
                                                    <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:20px;text-align:center"  runat="server" ID="LbCodePaletAlv"  Text="" > </asp:Label>
                                                </div>
                                                 <div class="col-lg-5" >
                                                </div>
                                            </div>
                                            <div class="row">
                                               <%-- <div class="col-lg-1" alig="left">
                                                ...
                                                <div class="col-lg-4"  alig="left">
                                                    ...
                                                    <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;"  runat="server" ID="LbCodeQRPalteAlv"  Text="SIN CÓDIGO LOTE" > </asp:Label>        
                                                </div>
