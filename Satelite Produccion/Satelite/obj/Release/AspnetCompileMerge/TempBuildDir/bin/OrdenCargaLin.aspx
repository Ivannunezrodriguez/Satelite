<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation = "false" CodeBehind="OrdenCargaLin.aspx.cs" Inherits="QRCode_Demo.OrdenCargaLin" MaintainScrollPositionOnPostback="true" %>
                ...
                <div class="row" id="cuestion" visible="false" runat="server">
                 ...
                 <div class="row" id="Decide" visible="false" runat="server">
                    <div class="col-lg-4">
                     ...
                     <div class="col-lg-4">
                        <asp:Button runat="server" ID="Button4" Visible="true" tooltip="Elimina la línea selecionada y corrige las posiciones en el camión" CssClass="btn btn-success btn-block" Width="100%"  Text="Eliminar y Corregir" OnClick="checkSiElC_Click"/>                 
                    </div>
                    <div class="col-lg-4">
              ...
              <div class="col-lg-12">
                 <div class="bs-example">
                    <ul class="nav nav-tabs" style="margin-bottom: 15px;">
                        ...
                        <li id="Menu4" class=""  runat="server" ><asp:LinkButton ID="aMenu4" runat="server" OnClick="HtmlAnchor_Click" >CARGA Y POSICION EN CAMION</asp:LinkButton></li>
                        ...
                        <%--<li id="Menu6" class=""  runat="server" ><asp:LinkButton ID="aMenu6" runat="server" OnClick="HtmlAnchor_Click" >CONFIGURACIÓN:</asp:LinkButton></li>
                          --%>
                        ...
                        <div class="row">
                             <div class="col-lg-6"> 
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" style=" font-weight: bold;" onclick="submitit1()"  href="#collapse1"> ORDENES DE CARGA: Cabeceras Órdenes
                        ...
                        <div class="panel panel-default">              
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-1"> 
                                        <br />
                                        <button id="btListaEmpresas" type="button" runat="server" style="width:50%; border-style:none; background-color:transparent;" class="pull-center text-muted "  onserverClick="btListaEmpresas_Click"><i id="idgvCabecera" runat="server" title="Despliega la lista de Cabecera para padidos"  class="fa fa-angle-up fa-2x"></i></button>
                                        <label runat="server" visible="true" tooltip="Muestra las Órdenes de cabecera cerradas"  id="LbCaCheck" class="switch pull-center">
                                            <input runat="server" id="CaCheck" data-toggle='tooltip' data-original-title='Edita campos con listas' onclick="submititCab()" type="checkbox"/><span class="slider round"></span>
                            ...
                            <div class="panel-body" id="EmpresaGV" visible="true" runat="server">
                                 <div class="row">                                                                       
                                       ...
                                       <%--<div class="col-sm-1" >
                                           <button id="BtCodigo" type="button" runat="server" style="width:100%; overflow:auto; border-style:none; background-color:transparent;" class="pull-center text-muted "  onserverClick="BtContiene_Click"><i id="INombre" style="color:darkred;" runat="server" title="Deberá contener estos Datos" class="fa fa-hand-o-up fa-2x"></i></button> 
                                       </div>--%>
                                    ...
                                    <div id="Div1" runat="server" style="overflow:auto;" class="panel-body"> <%-- AutoGenerateSelectButton="True"--%>  
                                        ...
                                        <RowStyle />                     
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Fecha Modificación" SortExpression="ZSYSDATE">
                                                        <EditItemTemplate>
                                                             <asp:TextBox ID="TabZSYSDATE" Width="100%" runat="server" Text='<%# Eval("ZSYSDATE") %>' class="gridCabBinput"></asp:TextBox>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                             <asp:Label ID="LabZSYSDATE" Width="100%" runat="server" Text='<%# Bind("ZSYSDATE") %>'></asp:Label>
                                                        </ItemTemplate>
                                                 </asp:TemplateField>
