<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="thEnd.aspx.cs" Inherits="QRCode_Demo.thEnd" %>
...
<body>
    ...
    <div id="wrapper">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                      <%--  <li><a href="#"><i class="fa fa-user fa-fw"></i> Perfil de usuario</a>
                        ...
                        <li class="divider"></li>--%>
                        <li><a href="login.aspx"><i class="fa fa-sign-out fa-fw"></i> Login</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
        ...
        <%--<div id="page-wrapper">--%>
        <div>
                <img style="background-size: cover;width:100%;" src="Images/FinalSesion.png"/>
        </div>
            <!-- /.row -->
