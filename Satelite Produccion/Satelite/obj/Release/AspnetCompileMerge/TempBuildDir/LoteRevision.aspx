<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoteRevision.aspx.cs" Inherits="QRCode_Demo.LoteRevision" MaintainScrollPositionOnPostback="true" %>
                    ...
                    <div class="panel-body">
                     ...
                     <div class="row">  
                        ...
                        <%--<div class="col-lg-2" >
                         ...
                         <div class="col-lg-2" >
                              <asp:Button runat="server" ID="BtFinalizaTodos" Visible="false" tooltip="Finaliza los lotes seleccionados con el check " CssClass="btn btn-warning btn-block"  Width="100%"  Text="Finalizar Lotes" OnClick="BtFinalizaTodos_Click"/>                              
                               <asp:Button runat="server" ID="BtEnviaFinalizados" Visible="false" tooltip="Envia todos los Lotes finalizados a GoldenSoft. Sino revertir Lote." CssClass="btn btn-info btn-block"  Width="100%"  Text="Enviar TODOS los Lotes" OnClick="BtEnviaFinalizados_Click"/>                              
                         </div>
                        <div class="col-lg-1" >
                        </div>
                         <div class="col-lg-2" >
