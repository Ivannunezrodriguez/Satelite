<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoteManu.aspx.cs" Inherits="QRCode_Demo.LoteManu" MaintainScrollPositionOnPostback="true" %>
                    ...
                    <div class="col-lg-5">
                        <div class="panel panel-default">
                           ...
                           <div class="panel-body">
                               ...
                               <div class="col-lg-9" >
                                   <asp:DropDownList runat="server" CssClass="form-control"  Width="100%" tooltip="Seleccione un Tipo de Lote para filtrar de las listas"  ID="DrVariedad"  OnSelectedIndexChanged="DrVariedad_SelectedIndexChanged" AppendDataBoundItems="true" AutoPostBack="True" Font-Bold="True" />
                               </div>

                               <div class="col-lg-3" >
                                   <asp:Button runat="server" ID="btNew" Enabled="false" tooltip="Genera la vista previa del Lote introducido en la casilla Código Lote" CssClass="btn btn-success btn-block" Width="100%"  Text="Generar" OnClick="btnNew_Click"/>
                               </div>
                               ...
                               <div class="col-lg-12" >
                                ...
                                <asp:TextBox ID="txtQRCode" Enabled="true" style="text-align:center; font-size:36px; font-weight: bold;" runat="server" Width="100%" CssClass="form-control" ></asp:TextBox>
                               <%-- <br />
                               ...
                               <div class="col-lg-12" >
                                   ...
                                   <%--<div class="col-lg-4" >
                                    <asp:Button runat="server" ID="btnNuevoLote" visible="false" tooltip="Para crear códigos QR ajenos e independientes" CssClass="btn btn-info btn-block" Width="100%"  Text="Nuevo" OnClick="btnNuevoLote_Click"/>
                                     <asp:Button runat="server" ID="BtGuardaLote" visible="false" tooltip="Guardar los códigos QR ajenos e independientes en Base de Datos" CssClass="btn btn-success btn-block" Width="100%"  Text="Guardar" OnClick="BtGuardaLote_Click"/>
                                    </div>
                                    <div class="col-lg-4" >
                                    <asp:Button runat="server" ID="BtModifica" visible="false" CssClass="btn btn-success btn-block" Width="100%"  Text="Modificar" OnClick="btnModifica_Click"/>
                                    <asp:Button runat="server" ID="BtCancelaLote" visible="false" tooltip="Cancela el código QR ajeno e independiente que estes tratando" CssClass="btn btn-warning btn-block" Width="100%"  Text="Cancelar" OnClick="btnCancelaLote_Click"/>
                                    </div>
                                    <div class="col-lg-4" >
                                        <asp:Button runat="server" ID="BtDelete" visible="false" tooltip="Marca como borrado el código QR seleccionado" CssClass="btn btn-success btn-block" Width="100%"  Text="Eliminar" OnClick="btnDelete_Click"/>
                            ...
                            <div class="panel-body" style="height:900px;"> 
                                ...
                                <div class="col-lg-7" >
                                    <asp:Panel ID="pnlContents" Visible="true" runat="server">
                                            <br />
                                            <br />
                                            <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:24px;text-align:left;"  runat="server" ID="LbCodigoLote"  Text="SIN CÓDIGO LOTE" > </asp:Label>
                                            <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:40px;text-align:left;"  runat="server" ID="LbSecuenciaLote"  Text="" > </asp:Label>
                                            <asp:PlaceHolder ID="PlaceHolder1"  runat="server"></asp:PlaceHolder>
                                            <br />
                                            <br />
                                            <div class="col-lg-12" >
                                            <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:24px;text-align:left;"  runat="server" ID="LbCampoS"  Text="" > </asp:Label>
                                            <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:24px;text-align:left;"  runat="server" ID="LbPlantaS"  Text="" > </asp:Label>
                                            <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:24px;text-align:left;"  runat="server" ID="LbFechaS"  Text="" > </asp:Label>
                                            <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:24px;text-align:left;"  runat="server" ID="LbVariedadS"  Text="" > </asp:Label>
                                            <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:24px;text-align:left;"  runat="server" ID="LbCajasS"  Text="" > </asp:Label>
                                            <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:24px;text-align:left;"  runat="server" ID="LbPlantasS"  Text="" > </asp:Label>
                                            </div>
                                            <br />
                                            <br />
                                            <div class="col-lg-12" >
                                                <asp:PlaceHolder ID="PlaceHolder2"  runat="server"></asp:PlaceHolder>
                                            <asp:Label  type="text" Width="100%" style=" font-weight: bold;text-align:left;"  runat="server" ID="Lbcompleto"  Text="" > </asp:Label>
                                            </div>
                                    </asp:Panel>
                                    <asp:Panel ID="pnlContentsQR" Visible="false" runat="server">
                                        ...
                                        <div class="col-lg-6" style="text-align: center;" >
                                            ...
                                            <asp:Label  type="text" style=" font-weight: bold; font-size:40px;text-align:left;"  runat="server" ID="LbSecuenciaLoteQR"  Text="" > </asp:Label>
                                            <br />
                                ...
                                <div class="col-lg-1" >
                                    <asp:Label  type="text" Width="100%" style=" font-weight: bold; font-size:12px;text-align:left;"  runat="server" ID="LbDateForm"  Text="" > </asp:Label> 
                                 </div>
                            </div>        
                           </div> 
                      </div>
