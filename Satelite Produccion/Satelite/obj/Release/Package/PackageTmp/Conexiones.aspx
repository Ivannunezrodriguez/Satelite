<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Conexiones.aspx.cs" Inherits="Satelite.Conexiones" %>
                                    ...
                                    <div class="panel" style="height:400px;" visible="true" runat="server" id="DivPanelFlujo">
                                       ...
                                       <%-- <asp:Label CssClass="cajaslabel" runat="server" ID="Label1"  Width="100%"  Text="Registros:"> </asp:Label>
										...
										<div class="row">
											...
											<div class="col-lg-4"> 
												<asp:Button runat="server" Enabled="true" ID="BtPruebaCon" Visible="false" CssClass="btn btn-info btn-block" Width="100%" Text="Probar Conexión" OnClick="BtPruebaCon_Click"/>
											</div>
											<div class="col-lg-4"> 
											</div>
										</div>
                        ...
                        <div class="col-lg-8"  style="height:420px;">
                            <div class="panel panel-default"  >
                                <div class="panel-heading">
                                    <div class="row">
                                        <div class="col-lg-12" >
                                            <asp:Label CssClass="cajaslabel" type="text" runat="server" ID="Label20" Width="80%" style="font-size:18px; font-weight: bold;"   Text="Conexión Seleccionada: "> </asp:Label>
                                        </div>
                                    </div>
                                </div>
                                       ...
                                       <%--<div class="row">
										...
										<div class="panel-heading" visible="false" runat="server" id="DivMenuTit">
											<div class="row" visible="true"  runat="server" id="DivMenudes">
												<div class="col-lg-6">
													<asp:Label CssClass="cajaslabel" type="text" runat="server" ID="LbMenuAsig" Width="100%" style="font-size:18px; font-weight: bold;"   Text="Menú Grupo seleccionado: "> </asp:Label>
   
												</div>
												<div class="col-lg-6">
													<asp:Label CssClass="cajaslabel" type="text" runat="server" ID="LbMenuJerar" Width="100%" style="font-size:18px; font-weight: bold;"   Text="Menú Usuario: "> </asp:Label>
												</div>
											</div>
										</div>
										<div class="row" visible="false" style="height:340px;" runat="server" id="DivMenuSel">
