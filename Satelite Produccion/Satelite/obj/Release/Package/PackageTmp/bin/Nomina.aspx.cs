...
namespace Satelite
{
    public partial class Nomina : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    //HtmlGenericControl li = (HtmlGenericControl)cont.FindControl("DvPreparado");
            ...
            catch (Exception ex)
            {
                ...
                string a = Main.ETrazas("", "1", " Nominas.Page_load --> Error:" + ex.Message);
        ...
        private void Campos_ordenados()
        {
            ...
            DrMeses.Items.Insert(9, new ListItem( "Octubre", "9"));
            ...
            //DrAno.Items.Insert(0, new ListItem("2023", "0"));
            //DrAno.Items.Insert(0, new ListItem("2022", "1"));
            //DrAno.Items.Insert(1, new ListItem("2021", "2"));
            //DrAno.Items.Insert(2, new ListItem("2020", "3"));
            //DrAno.Items.Insert(3, new ListItem("2019", "4"));
            //DrAno.SelectedIndex = 0;
        ...
        public void Carga_Menus()
        {
            ...
            if (this.Session["Menu"].ToString() == "0")
            {
                ...
                li.Attributes["class"] = "";
                li = (HtmlGenericControl)cont.FindControl("Menu7");
                li.Attributes["class"] = "";
                li = (HtmlGenericControl)cont.FindControl("Menu8");
                li.Attributes["class"] = "";
                li = (HtmlGenericControl)cont.FindControl("Menu9");
                li.Attributes["class"] = "";
                li = (HtmlGenericControl)cont.FindControl("Menu10");
                li.Attributes["class"] = "";
                li = (HtmlGenericControl)cont.FindControl("Menu11");
                li.Attributes["class"] = "";
                panel = (HtmlGenericControl)cont.FindControl("accordion0");
                ...
                panel.Attributes["class"] = "tab-pane fade";
                panel = (HtmlGenericControl)cont.FindControl("PnJornalHora");
                panel.Attributes["class"] = "tab-pane fade";
                panel = (HtmlGenericControl)cont.FindControl("PnJornalNomina");
                panel.Attributes["class"] = "tab-pane fade";
                panel = (HtmlGenericControl)cont.FindControl("PnProddiaImporte");
                panel.Attributes["class"] = "tab-pane fade";
                panel = (HtmlGenericControl)cont.FindControl("PnResumenNomina");
                panel.Attributes["class"] = "tab-pane fade";
                panel = (HtmlGenericControl)cont.FindControl("PnInformes");
                panel.Attributes["class"] = "tab-pane fade";
                panel = (HtmlGenericControl)cont.FindControl("PnlTrabajos");
                panel.Attributes["class"] = "tab-pane fade";
                panel = (HtmlGenericControl)cont.FindControl("PanelRaw");
                panel.Attributes["class"] = "tab-pane fade";
        ...
        private void UltimaConsulta()
        {
            ...
            Object Con = DBHelper.ExecuteScalarSQL("SELECT TARIFA FROM REC_TARIFAS A WHERE SUBTIPO ='RESTAR' AND TIPO = 'VIVIENDA'", null);
        ...
        {
            //ContentPlaceHolder cont = new ContentPlaceHolder();
            //HtmlGenericControl li2 = (HtmlGenericControl)Master.FindControl("cuestion");
            //li2 = (HtmlGenericControl)Master.FindControl("cuestion");
            //li2.Visible = true;
            //li2 = (HtmlGenericControl)Master.FindControl("Asume");
            //li2.Visible = false;
            //li2 = (HtmlGenericControl)Master.FindControl("DvPreparado");
            //li2.Visible = true;
            //Label li = (Label)Master.FindControl("Lbmensaje");
            //li.Text = "Se eliminarán los registros actuales " + LbUltConsulta.Text + ", con una nueva consulta ¿Desea continuar?";


            Lbmensaje.Text = "Se eliminarán los registros actuales " + LbUltConsulta.Text + " con esta nueva consulta ¿Desea continuar? <br/> <br/>";
            Lbmensaje.Text += "Si pulsa ACEPTAR el sistema quedará actualizado una vez desaparezca este mensaje.";
        ...
        protected void Lanza80_Click(object sender, EventArgs e)
        {
            ...
            if (dt1.Rows.Count == 0)
            {
                ...
                SQL += " VALUES ('" + TxtDesde.Text + "','" + TxtHasta.Text + "','" + DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss") + "') ";
            }
            else
            {
            ...
            try
            {
                ...
                foreach (DataRow fila in dt1.Rows)
                {
                    ...
                    SQL += fila["DESCRENVASE"].ToString() + "'," + fila["MARCAENVASE"].ToString().Replace(",",".") + "," + fila["PLANTAS"].ToString().Replace(",", ".") + ")";
            ...
            {
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas("", "1", " Lanza80 --> Error:" + ex.Message + " --> " + context.Session["Procedimiento"].ToString());
        ...
        protected void BtGralConsulta_Click(object sender, EventArgs e)
        {
            ...
            //pmtProc1.Text = "Eliminando Datos...";
#pragma warning disable CS0219 // La variable 'Donde' está asignada pero su valor nunca se usa
            int Donde = 0;
#pragma warning restore CS0219 // La variable 'Donde' está asignada pero su valor nunca se usa
            ...
            try
            {
                ...
                {
                    SQL = " INSERT INTO REC_JORNADA ( COD_EMPLEADO,NOMBRE,APELLIDOS,"; //REC_JORNADAS_RECODAT
                    SQL += " FECHA_JORNADA , HORAINI ,HORAFIN ,TRANSCURRIDO , RECOTABLET, DIASMES)";
                    SQL += " VALUES('" + fila["COD_EMPLEADO"].ToString() + "','" + fila["NOMBRE"].ToString() + "','" + fila["APELLIDOS"].ToString() + "','";
                    SQL += fila["FECHA_JORNADA"].ToString() + "','" + fila["HORAINI"].ToString() + "','" + fila["HORAFIN"].ToString() + "','" + fila["TRANSCURRIDO"].ToString() + "','";
                    SQL += fila["RECOTABLET"].ToString() + "'," + fila["DIAS_DESCUENTO"].ToString() + ")";
                    //Lberror.Text += " --> 3- REC_JORNADA " + SQL + Environment.NewLine;
                    DBHelper.ExecuteNonQuery(SQL);
                    //Lberror.Text += Variables.Error + Environment.NewLine;
                }
                ...
                foreach (DataRow fila in dt1.Rows)
                {
                    SQL = " SELECT TOP 1 (B.CodEmpleado) AS COD_EMPLEADO, B.Nombre AS  NOMBRE, B.Apellidos AS APELLIDOS, ";
                    SQL += " B.codCentro AS CENTRO, B.codCategoria AS CATEGORIA, B.Domicilio AS VIVIENDA, ";
                    SQL += " (SELECT COALESCE(SUM(A.Importe), 0) FROM Anticipos A WHERE A.CodEmpleado = B.CodEmpleado AND A.CodConcepto = 'VD' ";
                    SQL += "  AND A.Fecha BETWEEN '" + TxtDesde.Text + "' AND '" + TxtHasta.Text + "') as DIAS_DESCUENTO ";
                    SQL += " FROM EMPLEADOS B WHERE B.CodEmpleado = '" + fila["COD_EMPLEADO"].ToString() + "'";
                    ...
                    {
                        SQL = " INSERT INTO REC_EMPLEADO ( COD_EMPLEADO, NOMBRE, APELLIDOS,";
                        SQL += " CENTRO, CATEGORIA, VIVIENDA, BUSQUEDA, DIASDESCUENTO)";
                        SQL += " VALUES('" + fila2["COD_EMPLEADO"].ToString() + "','" + fila2["NOMBRE"].ToString() + "','" + fila2["APELLIDOS"].ToString() + "','";
                        SQL += fila2["CENTRO"].ToString() + "','" + fila2["CATEGORIA"].ToString() + "','" + fila2["VIVIENDA"].ToString() + "',0,";
                        SQL +=  fila2["DIAS_DESCUENTO"].ToString() + ")";
                        break;
                    }
                ...
                //Campos por defecto
                //JORNADA
                SQL = " UPDATE REC_JORNADA SET ALQVIVIENDA = 'Si',  COSTEVIVIENDA = 0 "; //DIASMES = 0,
                DBHelper.ExecuteNonQuery(SQL);
                Donde = 25;
                ...
                SQL += " WHEN FECHAALTA is NULL THEN ' " + TxtDesde.Text + "'  "; //Antes ''
                ...
                SQL += " WHEN FECHABAJA is NULL THEN '" + TxtHasta.Text + "'  "; //Antes ''
                ...
                Donde = 29;
                //EMPLEADO
                SQL = " UPDATE REC_EMPLEADO SET COSTEVIVIENDA = ((DIASMES - DIASDESCUENTO) - (SELECT TARIFA FROM REC_TARIFAS WHERE TIPO = 'VIVIENDA' AND SUBTIPO = 'RESTAR') ) * (SELECT TARIFA FROM REC_TARIFAS WHERE TIPO = 'VIVIENDA' AND SUBTIPO = '')  ";
                ...
                SQL = " UPDATE REC_JORNADA SET COSTEVIVIENDA = DIASMES * (SELECT TARIFA FROM REC_TARIFAS WHERE TIPO = 'VIVIENDA' AND SUBTIPO = '') , ";
                SQL += " TOTAL = TOTALIMPORTE - (DIASMES * (SELECT TARIFA FROM REC_TARIFAS WHERE TIPO = 'VIVIENDA' AND SUBTIPO = '')) "; // COSTEVIVIENDA ";
                SQL += " WHERE DIASMES > 0 AND ALQVIVIENDA = 'Si' ";
                ...
                SQL = " UPDATE REC_PRODUCCION SET COSTEVIVIENDA = DIASMES * (SELECT TARIFA FROM REC_TARIFAS WHERE TIPO = 'VIVIENDA' AND SUBTIPO = '') ";
                SQL += " WHERE DIASMES > 0 AND ALQVIVIENDA = 'Si' ";
                DBHelper.ExecuteNonQuery(SQL);
            ...
            {
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas(SQL, "1", " btGralCnsulta --> Error:" + ex.Message + " --> " + context.Session["Procedimiento"].ToString());
        ...
        //    {
        //        HttpContext context = HttpContext.Current;
        //        string a = Main.ETrazas(SQL, "1", " btGralCnsulta2 --> Error:" + ex.Message + " --> " + context.Session["Procedimiento"].ToString());
        ...
        protected void PrintNominas(string CodEmpleado, string Centro)
        {
            ...
            {
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas(SQL, "1", " PrintNomina --> Error:" + ex.Message + " --> " + context.Session["Procedimiento"].ToString());
        ...
        protected void PrintReport_Click(object sender, EventArgs e)
        {
            ...
            {
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas(SQL, "1", " PrintReport --> Error:" + ex.Message + " --> " + context.Session["Procedimiento"].ToString());
        ...
        //private void ETrazas(string SQL, string Nivel, string Procedimiento)
        //{
        //    if (this.Session["TrazaLog"].ToString() == "2")
        //    {
        //        string a = Main.Ficherotraza(Nivel + " --> " + SQL);
        //    }
        //    else if (this.Session["TrazaLog"].ToString() == "1" || Nivel != "0")
        //    {
        //        string a = Main.Ficherotraza(Nivel + " - " + Procedimiento +  " --> " + SQL);
        //    }
        //}
        ...
        {
            string SQL = "";
            this.Session["Procedimiento"] = "CreaNomina";
            try
            {
                DataTable dt = null;
                DataTable dtA = null;
                ...
                if (CodEmpleado == "Todos" || CodEmpleado == "Total")
                {
                    ...
                    this.Session["Procedimiento"] = "CreaNomina -->" + SQL ;

                    //Main.ETrazas(SQL, "0", "CreaNomina");
            ...
            {
                string a = Main.ETrazas(SQL, "1", " CreaNomina --> Error:" + ex.Message + " --> " + this.Session["Procedimiento"].ToString());
        ...
        protected void gvProduccion_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            {
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas("", "1", " gvProduccion_RowUpdating --> Error:" + ex.Message + " --> " + context.Session["Procedimiento"].ToString());
        ...
        protected void gvJornada_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            {
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas("", "1", "gvJornada_RowUpdating --> Error:" + ex.Message + " --> " + context.Session["Procedimiento"].ToString());
        ...
        protected void gvJornalHora_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
        {
            ...
            {
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas("", "1", "gvJornalHora_RowCommand --> Error:" + ex.Message + " --> " + context.Session["Procedimiento"].ToString());
        ...
        protected void gvJornalNomina_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
        {
            ...
            {
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas("", "1", "gvJornalNomina_RowCommand --> Error:" + ex.Message + " --> " + context.Session["Procedimiento"].ToString());
        ...
        protected void gvDestajoNomina_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
        {
            ...
            {
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas("", "1", "gvDestajoNomina_RowCommand --> Error:" + ex.Message + " --> " + context.Session["Procedimiento"].ToString());
        ...
        protected void gvResumenNomina_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
        {
            ...
            {
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas("", "1", "gvResumenNomina_RowCommand --> Error:" + ex.Message + " --> " + context.Session["Procedimiento"].ToString());
        ...
        protected void gvTrabajos_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
        {
            ...
            {
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas("", "1", "gvTrabajos_RowCommand --> Error:" + ex.Message + " --> " + context.Session["Procedimiento"].ToString());
        ...
        protected void gvpanelTareas_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
        {
            ...
            {
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas("", "1", "gvpanelTareas_RowCommand --> Error:" + ex.Message + " --> " + context.Session["Procedimiento"].ToString());
        ...
        protected void gvProdImpDia_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
        {
            ...
            {
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas("", "1", "gvProdImpDia_RowCommand --> Error:" + ex.Message + " --> " + context.Session["Procedimiento"].ToString());
        ...
        protected void gvProduccion_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas("", "1", "gvProduccion_RowCommand --> Error:" + ex.Message + " --> " + Lberror.Text + context.Session["Procedimiento"].ToString());
        ...
        protected void gvJornada_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas("", "1", "gvJornada_RowCommand --> Error:" + ex.Message + " --> " + Lberror.Text + context.Session["Procedimiento"].ToString());
        ...
        private void Carga_tablaCabeceraClose()
        {
            ...
            try
            {
                ...
                if (ConfigurationManager.AppSettings.Get("Desarrollo").ToString() == "1")
                {
                    ...
                    //SQL += " FROM ZCARGA_CABECERA  WHERE ESTADO = 2  ";
                    if (filtros != "")
                    {
                        SQL += filtros;
                    }
                ...
                else
                {
                    ...
                    //SQL = " SELECT ID, NUMERO, EMPRESA, PAIS, FECHACARGA, TELEFONO, MATRICULA,";
                    //SQL += " TRANSPORTISTA, TELEFONO_USER, LATITUD, LONGITUD, OBSERVACIONES, ID_SECUENCIA, ESTADO ";
                    //SQL += " FROM ZCARGA_CABECERA  WHERE ESTADO = 2  "; //jose
                    //SQL += " FROM ZCARGA_CABECERA  WHERE (ESTADO <> 2 OR ESTADO IS NULL) ";
                    if (filtros != "")
                    {
                        SQL += filtros;
                    }
            ...
            catch (Exception ex)
            {
                ...
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas(SQL, "1", "CargaTablacabeceraClose --> Error:" + ex.Message + " --> " + Lberror.Text + context.Session["Procedimiento"].ToString());
        ...
        private void Carga_tablaJornadaSQL()
        {
            ...
            {
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas(SQL, "1", "Carga_TablaJornadaSQL --> Error:" + ex.Message + " --> " + Lberror.Text + context.Session["Procedimiento"].ToString());
        ...
        private void Carga_tablaJornada(string sortExpression = null)
        {
            ...
            catch (Exception ex)
            {
                ...
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas(SQL, "1", "Carga_TablaJornada --> Error:" + ex.Message + " --> " + context.Session["Procedimiento"].ToString());
        ...
        private void Carga_tablaProduccion(string sortExpression = null)
        {
            ...
            catch (Exception ex)
            {
                ...
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas(SQL, "1", "Carga_TablaProduccion --> Error:" + ex.Message + " --> " + context.Session["Procedimiento"].ToString());
        ...
        private void Carga_tablaTareas()
        {
            ...
            try
            {
                ...
                if (ConfigurationManager.AppSettings.Get("Desarrollo").ToString() == "1")
                {
                    //SQL = " SELECT * FROM ZCARGA_LINEA  WHERE COMPUTER = '" + this.Session["ComputerName"].ToString() + "' " + filtro + " ORDER BY POSICIONCAMION ";
                ...
                else
                {
                    ...
                    //SQL = " SELECT * FROM ZCARGA_LINEA  ORDER BY POSICIONCAMION ";
                    //dt = Main.BuscaLote(SQL).Tables[0];
                }
            ...
            {
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas(SQL, "1", "Carga_TablaTareas --> Error:" + mm.Message + " --> " + context.Session["Procedimiento"].ToString());
        ...
        private void Carga_tablaTrabajos(string sortExpression = null)
        {
            ...
            {
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas(SQL, "1", "Carga_TablaTrabajos --> Error:" + mm.Message + " --> " + context.Session["Procedimiento"].ToString());
        ...
        {
            //Tabla REC_Empleados
            string SQL = " COD_EMPLEADO, NOMBRE, APELLIDOS, CENTRO, CATEGORIA, FECHAALTA, COTIZACION, FECHABAJA, VIVIENDA, ALQVIVIENDA, DIASMES, COSTEVIVIENDA, IMPORTE, NOMINA, DIASDESCUENTO";
            DataTable dt = null;
            string Dato = ""; // TxtNumero.Text;
            Carga_FiltrosGral(SQL);
            //Carga_tablaListaFiltros(SQL);
            ...
            try
            {
                ...
                //{
                    ...
                    SQL = " SELECT ID, COD_EMPLEADO, NOMBRE, APELLIDOS, CENTRO, CATEGORIA, FORMAT(FECHAALTA, 'dd-MM-yyyy') AS FECHAALTA, COTIZACION, ";
                    SQL += " CASE WHEN FORMAT(FECHABAJA, 'dd-MM-yyyy') = '01-01-1900' THEN null ELSE FORMAT(FECHABAJA, 'dd-MM-yyyy') END AS FECHABAJA , VIVIENDA, ";
                    SQL += " ALQVIVIENDA, DIASMES, COSTEVIVIENDA, (IMPORTE - COSTEVIVIENDA) AS  IMPORTE, NOMINA, DIASDESCUENTO ";
                    SQL += " FROM REC_EMPLEADO  ";
                    SQL += " WHERE COD_EMPLEADO IS NOT NULL ";
                ...
                //    SQL = " SELECT ID, COD_EMPLEADO, NOMBRE, APELLIDOS, CENTRO, CATEGORIA, FORMAT(FECHAALTA, 'dd-MM-yyyy') AS FECHAALTA, COTIZACION, ";
                //    SQL += " CASE WHEN FORMAT(FECHABAJA, 'dd-MM-yyyy') = '01-01-1900' THEN null ELSE FORMAT(FECHABAJA, 'dd-MM-yyyy') END AS FECHABAJA , VIVIENDA, ";
                //    SQL += " ALQVIVIENDA, DIASMES, COSTEVIVIENDA, IMPORTE, NOMINA, DIASDESCUENTO ";
                //    SQL += " FROM REC_EMPLEADO  ";
                //    SQL += " WHERE COD_EMPLEADO IS NOT NULL ";
                //    //SQL += " AND ID_CABECERA = " + Dato + " ";
                //    //if (CheckTodo.Checked == true)
        ...
        public static DataTable ConsultaPalet()
        {
            ...
            {
                Variables.Error = mm.Message;
                string a = Main.ETrazas(SQL, "1", " ConsultaPalet --> Error:" + mm.Message + " --> " + context.Session["Procedimiento"].ToString());
        ...
        protected void AplicaTarifa_Click(Object Objeto, Object Container)
        {
            string SQL = " UPDATE REC_TARIFAS SET TARIFA = " + TxtTarifa.Text.Replace(",",".") + " WHERE SUBTIPO = 'RESTAR' AND TIPO = 'VIVIENDA'";
            DBHelper.ExecuteNonQuery(SQL);
        }
        ...
        //            if (ConfigurationManager.AppSettings.Get("Desarrollo").ToString() == "1")
        //            {
        //                //SQL += "DELETE FROM ZCARGA_ORDEN WHERE COMPUTER = '" + this.Session["ComputerName"].ToString() + "'";
        ...
        //                //SQL = " SELECT * FROM ZCARGA_ORDEN WHERE ESTADO in ( 0, 1) AND COMPUTER = '" + this.Session["ComputerName"].ToString() + "'  ORDER BY ID ";
        ...
        //                //SQL = " SELECT * FROM ZCARGA_ORDEN  ORDER BY ID ";
        ...
        //            else
        //            {
        //                //SQL += "DELETE FROM ZCARGA_ORDEN WHERE ESTADO in ( 0, 1) AND COMPUTER = '" + this.Session["ComputerName"].ToString() + "'";
        //                if (temporal == "")
        //                {
        ...
        //                //SQL = " SELECT * FROM ZCARGA_ORDEN " + Filtros + " AND  ESTADO in ( 0, 1) AND COMPUTER = '" + this.Session["ComputerName"].ToString() + "'  ORDER BY ID ";
        ...
        private static DataTable Calcula_OrdenesCarga(DataTable dt, string Estado, string Numero)
        {
            ...
            try
            {
                if (ConfigurationManager.AppSettings.Get("Desarrollo").ToString() == "1")
                {
                    ...
                    SQL += " FROM ZCARGA_LINEA  WHERE ESTADO < 3  AND ID_CABECERA = " + Numero;
            ...
            catch (Exception Ex)
            {
                ...
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas(SQL, "1", " Calcula_OrdenesCarga --> Error:" + Ex.Message + " --> " + context.Session["Procedimiento"].ToString());
        ...
        private void Carga_Jornal_Nominas(string sortExpression = null)
        {
            ...
            if (dias != 0)
            {
                ...
                SQL += " , (SELECT CONVERT(Decimal(8, 2), ((sum(R.TOTALMINUTOS) * N.TARIFA / 60))) - A.COSTEVIVIENDA  ";
                SQL += "   FROM REC_JORNADA R, REC_TARIFAS N    WHERE N.TIPO = 'VIVIENDA' AND N.SUBTIPO = '' AND R.COD_EMPLEADO = C.COD_EMPLEADO  ";
                SQL += "   GROUP BY N.TARIFA) as TOTAL  ";
                ...
                SQL += "   WHEN C.COTIZACION = 7 THEN CONVERT(DECIMAL (8,2),(CONVERT(Decimal(8, 2), ((sum(R.TOTALMINUTOS) * N.TARIFA / 60))) - R.COSTEVIVIENDA) * " + diasNaturales + " / R.DIASMES) END ";
                SQL += "   FROM REC_JORNADA R, REC_TARIFAS N ";
                SQL += "   WHERE N.TIPO = 'VIVIENDA' AND N.SUBTIPO = '' AND R.COD_EMPLEADO = C.COD_EMPLEADO ";
                SQL += "   GROUP BY R.COD_EMPLEADO, R.COSTEVIVIENDA, N.TARIFA, R.DIASMES) AS NOMINA ";
        ...
        public static DataTable Carga_TrabajosXLS(string SQL)
        {
            ...
            {
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas(SQL, "1", " Carga_TrabajosXLS --> Error:" + mm.Message + " --> " + context.Session["Procedimiento"].ToString());
        ...
        private void Carga_Trabajos(string sortExpression = null)
        {
            ...
            {
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas(SQL, "1", " Carga_Trabajos --> Error:" + mm.Message + " --> " + context.Session["Procedimiento"].ToString());
        ...
        private void Carga_panelTareasSQL()
        {
            ...
            SQL += " FROM REC_TAREAS A, REC_EMPLEADO B  ";
            SQL += " WHERE A.COD_EMPLEADO IS NOT NULL";
        ...
        private void Carga_panelTareas(string sortExpression = null)
        {
            ...
            {
                HttpContext context = HttpContext.Current;
                string a = Main.ETrazas(SQL, "1", " Carga_gvpanelTareas --> Error:" + mm.Message + " --> " + context.Session["Procedimiento"].ToString());
