...
namespace Satelite
{
    public partial class POnLine : System.Web.UI.Page
    {
...
#pragma warning disable CS0168 // La variable 'ex' se ha declarado pero nunca se usa
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    this.Session["MiNivel"] = "1";
                    this.Session["DESARROLLO"] = "DESARROLLO";
                    this.Session["MiCodigo"] = "0";
                    this.Session["MiMenu"] = "OnLine";
                    this.Session["ComputerName"] = "Web";
...
#pragma warning restore CS0219 // La variable 'data' está asignada pero su valor nunca se usa
        ...
        private void CreaGridMiControl(DataTable dtArchivo, DataTable dtCampo)
        {
            ...
            //Variable opcion manual o dinamica desde web.config
            int Manual = 0;
#pragma warning disable CS0219 // La variable 'cuantos' está asignada pero su valor nunca se usa
            int cuantos = 0;
#pragma warning restore CS0219 // La variable 'cuantos' está asignada pero su valor nunca se usa
            int i = 0;
            int a = 0;
            Boolean Esta = false;
...
#pragma warning disable CS0168 // La variable 'ex' se ha declarado pero nunca se usa
            try
            {
                ...
                {
#pragma warning disable CS0219 // La variable 'UNIDADES' está asignada pero su valor nunca se usa
                    decimal UNIDADES = 1.0M;
#pragma warning restore CS0219 // La variable 'UNIDADES' está asignada pero su valor nunca se usa
...
#pragma warning disable CS0219 // La variable 'NombreCajaTexto' está asignada pero su valor nunca se usa
                    string NombreCajaTexto = "";
#pragma warning restore CS0219 // La variable 'NombreCajaTexto' está asignada pero su valor nunca se usa
