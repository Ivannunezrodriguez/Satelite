<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Satelite.Register" %>
 ...
 <form id="Form1" runat="server">
            ...
            <header class="HeaderMain" data-test="header-main" role="banner">
                <div class="inner">
                    <div class="s-wrap">
                        <div class="FmLogo">
							<a class="s-tr" href="https://BladeTuring.com/">Blade Turing</a>
						</div>
                        <label class="NavMobileHamburger" for="open-nav-main">Menu</label><nav class="Nav NavMobile NavMain">
                            <input class="toggle-target" id="open-nav-main" type="checkbox"><ul>
                                <li class="item"><a href="Detalles.aspx">Detalle</a></li>
                                <li class="item"><a href="Acciones.aspx">Acciones</a></li>
                                <li class="item"><a href="Plantillas.aspx">Plantillas</a></li>
                                <li class="item"><a href="login.aspx">Login</a></li>
                                <li class="item"><a class="Button ButtonRed" href="Registro.aspx">Registrate ahora</a></li>
								<li class="item"></li>
								<li class="item"></li>
								...
								<li class="item"><a href="Login.aspx">						
                                ...
                                <li class="item"><a href="#">
                                    <button id="fullScreenBtIf" title="" style="Color:#000; background-color:#ff6a00; border-style:none;" runat="server" onclick="toggleFullscreen()"  width="0px" height="0px"><span class="screen-reader-text"></span></button>
                                    <asp:TextBox type="text" style="Color:#000; background-color:#ff6a00; border-style:none;" TextMode="MultiLine" runat="server" ID="Tssu" Width="0px" Height="0px"></asp:TextBox>
                                    <asp:TextBox type="text" style="Color:#000; background-color:#ff6a00; border-style:none;" TextMode="MultiLine" runat="server" ID="Tssp" Width="0px" Height="0px"></asp:TextBox>
                                    <asp:TextBox type="text" style="Color:#000; background-color:#ff6a00; border-style:none;" TextMode="MultiLine" runat="server" ID="Tssd" Width="0px" Height="0px"></asp:TextBox>
                                    <asp:TextBox type="text" style="Color:#000; background-color:#ff6a00; border-style:none;" TextMode="MultiLine" runat="server" ID="SsID" Width="0px" Height="0px"></asp:TextBox>
                                    <asp:TextBox type="text" style="Color:#000; background-color:#ff6a00; border-style:none;" TextMode="MultiLine" runat="server" ID="TssSB" Width="0px" Height="0px"></asp:TextBox>
                                    <asp:TextBox type="text" style="Color:#000; background-color:#ff6a00; border-style:none;" TextMode="MultiLine" runat="server" ID="TssA" Width="0px" Height="0px"></asp:TextBox>
                                    <asp:TextBox type="text" style="Color:#000; background-color:#ff6a00; border-style:none;" TextMode="MultiLine" runat="server" ID="TssX" Width="0px" Height="0px"></asp:TextBox>
                                    <asp:TextBox type="text" style="Color:#000; background-color:#ff6a00; border-style:none;" TextMode="MultiLine" runat="server" ID="TssZ" Width="0px" Height="0px"></asp:TextBox>
								   </a>
								</li>
                            </ul>
                        </nav>
                ...
                <svg class="diagonal" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 10" preserveAspectRatio="none">
                    <defs>
                        <linearGradient id="linear" x1="0%" y1="0%" x2="100%" y2="0%">
                            <stop offset="0%" stop-color="#f02d28"></stop>
                            <stop offset="100%" stop-color="#366225"></stop>
                        </linearGradient>
    ...
    <video autoplay="autoplay" loop="loop" id="video_background" preload="auto" muted="muted" poster="Images/Portada10.png">
        <source src="Images/video10.mp4" type="video/mp4">
    </video>
    <div class="loginBox">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img style="height:40px; width:200px; align-content:center;" src="Images/titulo2.png">
        <h2>ACCESO</h2>
            ...
            <br />
            <asp:HyperLink ID="HypRegistro" left="100px" align="right" runat="server" NavigateUrl="Registro.aspx">Si aún no estás registrado..</asp:HyperLink>         
