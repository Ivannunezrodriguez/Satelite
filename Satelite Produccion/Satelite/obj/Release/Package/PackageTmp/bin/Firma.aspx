<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Firma.aspx.cs" Inherits="Satelite.Firma" EnableEventValidation="false" %>
            ...
            <div class="row" >
                <div class="col-lg-12"  >
                    ...
                    <ul class="nav nav-tabs" style="margin-bottom: 15px;" >
                        <li id="Menu0" class="active" runat="server" ><asp:LinkButton ID="aMenu0" runat="server" OnClick="HtmlAnchor_Click" >FIRMA ELECTRÓNICA DE DOCUMENTOS</asp:LinkButton></li>                        
