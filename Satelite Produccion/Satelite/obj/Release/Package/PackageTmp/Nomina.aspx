<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Nomina.aspx.cs" Inherits="Satelite.Nomina" %>
...
<%--    <div class="row" id="Div28" visible="true" runat="server">
        <div class="col-lg-1">
        ...
        <div class="col-lg-11">--%>
            ...
            <div id="page_wrapper" runat="server" ><!-- /#page-wrapper  class="portada"-->
                ...
                <%-- <div class="centrado"  ID="DivProgress" runat="server" visible="false" style="z-index:1100;">
                                ...
                                <div class="panel panel-default">           
                                    <div class="panel-body" id="Div6" visible="true" runat="server">
                                         <div class="row">                                                                       
                                                ...
                                                <div class="col-sm-1" >
                                                    <asp:TextBox runat="server" CssClass="form-control" Visible="true"  Width="100%" tooltip="Introduzca Fecha Hasta para filtrar datos"  ID="TxtHasta"  Font-Bold="True" />
                                                </div>
                                                <%--<div class="col-sm-1" >
                                                 </div>--%>
                                                <div class="col-sm-3" >
                                                    ...
                                                    <div class="col-sm-1" >
                                                        <asp:ImageButton id="ImgFechamenos" visible="true" runat="server" ToolTip="Atrás Meses" ImageAlign="right" Width="25px" Height="30px" ImageUrl="images/menos.png" OnClick="BtFechaMas_Click"/>
                                                        </div>
                                                    <div class="col-sm-5" >
                                                        <asp:DropDownList ID="DrAno" CssClass="form-control" Width="100%" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DrMeses_Changed"></asp:DropDownList>
                                                        </div>
                                                    <div class="col-sm-5" >
                                                        <asp:DropDownList ID="DrMeses" CssClass="form-control" Width="100%" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DrMeses_Changed"></asp:DropDownList>
                                                        </div>
                                                    <div class="col-sm-1" >
                                                        <asp:ImageButton id="ImgFechamas" visible="true" runat="server" ToolTip="Adelante Meses" ImageAlign="left" Width="25px" Height="30px" ImageUrl="images/mas.png" OnClick="BtFechaMas_Click"/>
                                                    </div>
                                                </div>
                                                 <%--<div class="col-sm-1" >
                                                 </div>--%>
                                ...
                                <div class="panel panel-default">              
                                    <div class="panel-body" id="EmpresaGV" visible="true" runat="server">
                                         <div class="row">                                                                       
                                                ...
                                                <div class="col-sm-2" >
                                                     <asp:Label  type="text"  Width="100%" style=" font-weight: bold;text-align:right; padding:6px;"  runat="server" ID="Label9"  Text="Vivienda. Días descuento general:" > </asp:Label>
                                                </div>
                                                <div class="col-sm-1" >
                                                     <asp:TextBox runat="server" CssClass="form-control" Visible="true"  Width="100%" tooltip="Días descuento sobre Vivienda aplicado en Tarifas "  ID="TxtTarifa" Text=""  Font-Bold="True" />
                                                </div>
                                                <div class="col-sm-1" >
                                                    <asp:ImageButton id="ImageButton1" visible="true" runat="server" ToolTip="Actualiza los días de descuento a la tabla de Tarifas. Debe generar la consulta nuevamente para que aplique los cambios " ImageAlign="right" Width="30px" Height="30px" ImageUrl="images/descargar.png" OnClick="AplicaTarifa_Click"/>
                                                </div>
                                                <%--<div class="col-sm-3" >
                                                ...
                                                <RowStyle />                     
                                                    <Columns>
                                                       ...
                                                       <%-- <asp:TemplateField  ItemStyle-HorizontalAlign="Center" >
                                                        ...
                                                        <asp:TemplateField HeaderText="Días-Descuento" SortExpression="DIASDESCUENTO">
                                                                <EditItemTemplate>
                                                                     <asp:TextBox ID="TabdiaDescuento" runat="server" Text='<%# Eval("DIASDESCUENTO") %>' class="gridCabBinput"></asp:TextBox>
                                                                </EditItemTemplate>
                                                                <ItemTemplate>
                                                                     <asp:Label ID="LabdiaDescuento" runat="server" Text='<%# Bind("DIASDESCUENTO") %>'></asp:Label>
                                                                </ItemTemplate>
                                                         </asp:TemplateField>
