...
namespace Satelite
{
    public partial class LoteAuto : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string miro = this.Session["IDSession"].ToString();
                if (this.Session["MiMenu"].ToString() == "OrdenCompra") // (this.Session["IDSession"].ToString() != "0") 
                {
                    Menus_Ocultos();
                }
                else
        ...
        private void Menus_Ocultos()
        {

            Menus.Visible = false;
            CabeceraLotes.Visible = false;
        }
