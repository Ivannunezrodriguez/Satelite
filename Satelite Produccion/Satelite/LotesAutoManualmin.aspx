<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="LotesAutoManualmin.aspx.cs" Inherits="Satelite.LotesAutoManualmin"  MaintainScrollPositionOnPostback="true" %>
...
<body>
    <form runat="server">
      <!--<div id="page_wrapper" style="width:100%;" runat="server" > /#page-wrapper  class="portada"-->
...
<%--                                <asp:Label ID="txtQRCodebis" Visible="true" style="text-align:center; color:red; font-size:18px; font-weight: bold;" runat="server" Width="100%" CssClass="form-control" ></asp:Label>--%>
                        ...
                        <div class="panel panel-default">
                            ...
                            <%--<h3 class="panel-title">--%> 
                                    <div class="col-lg-12" >
                                        <asp:Label  type="text"  style="font-weight: bold; text-align:left; font-size:14px;"  runat="server" ID="lbtitleLote"  Text="Existen Duplicados:" > </asp:Label>
                                         <asp:Label  type="text"  style=" font-weight: bold;text-align:left; font-size:14px;"  runat="server" ID="LbDuplicados"  Text="No" > </asp:Label>
                                        <asp:ImageButton id="Imageprocesa2" visible="true" runat="server" AlternateText="ImageButton 1" ImageAlign="right" Width="25px" Height="25px" ImageUrl="images/pnegro.png" OnClick="checkListas_Click"/>
                                        <asp:ImageButton id="Imageprocesa1" visible="false" runat="server" AlternateText="ImageButton 1" ImageAlign="right" Width="25px" Height="25px" ImageUrl="images/pazul.png" OnClick="checkListas_Click"/>
                                    </div>        
                            <%--</h3>--%> 
                                </div>
                               </div>
