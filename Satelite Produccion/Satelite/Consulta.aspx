<%@ Page Title="" Language="C#" ValidateRequest="false" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Consulta.aspx.cs" Inherits="Satelite.Consulta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    	...
    	<div runat="server" id="DivCampos0" visible="false"  style=" width: 90%;z-index: 1999;-moz-border-radius: 10px;-webkit-border-radius: 10px;border-radius: 10px;border: 0px solid black; box-shadow: inset 0 0 5px 5px rgb(157,157,155);" class="alert alert-grey centrado">
...
<%--									<div class="row" runat="server" id="DivUpFile" visible="true" style="width:100%; height:180px; text-align:left;" >
					...
					<div class="row" runat="server" id="DivTitulo2" visible="false" style="width:100%;" >	
						<div class="panel-body">
							<div class="col-lg-1" >
								<asp:ImageButton ImageUrl="~/Images/arbol.png"  runat="server"       
								ToolTip="Estructura de Documentos en árbol o en lista" Width="30px" Height="30px" OnClick="BtArbol_Click"></asp:ImageButton>
							</div>
							<div class="col-lg-5"  runat="server" id="Div2">
								<h3 id="H3" runat="server" style="text-align:left;font-size:16pt;" visible="true"> Directorio de Ficheros Adjuntos en el Registro </h3>
							</div>
							<div class="col-lg-1" >
							</div>
							<div class="col-lg-3" >
							</div>
							<div class="col-lg-2"  runat="server" id="Div3">
								<h3 id="H4" runat="server" style="text-align:right;font-size:16pt;" visible="true"> Subir Ficheros al Servidor </h3>
							</div>
							
						</div>
					</div>

					<div class="row" runat="server" id="DivDirectorios" visible="false" style="width:100%;" >	
						<div class="panel-body">
                    ...
                    <div class="row" runat="server" id="DivFicheros" visible="false" style="width:100%; height:180px;" >
						<div id="DivTreeDoc" visible="false" runat="server" style=" height:180px;overflow:auto;" class="col-lg-12">
							<br />
							<div class="panel-body">
						...
						<div id="DivGridDocReg" visible="false" runat="server" style=" height:180px;overflow:auto;" class="col-lg-12"> <%-- AutoGenerateSelectButton="True"--%>                                  
							<br />
							<asp:GridView ID="gvDoc"  runat="server" AutoGenerateColumns="False" class="table table-striped table-bordered table-condensed table-responsive table-hover " 
								AllowSorting="true" OnSorting="gvDoc_OnSorting"
								CellPadding="4"  GridLines="None"  OnRowDataBound="gvDoc_OnRowDataBound"  width="100%" AllowPaging="True" PageSize="100" OnRowCommand="gvDoc_RowCommand" DataKeyNames="ZID"
								oonselectedindexchanged="gvDoc_SelectedIndexChanged"  OnRowEditing="gvDoc_RowEditing" OnRowCancelingEdit="gvDoc_RowCancelingEdit" OnRowUpdating="gvDoc_RowUpdating" 
								onpageindexchanging="gvDoc_PageIndexChanging" EnablePersistedSelection="True"  >
							<RowStyle />                     
								<Columns>
									...
									<asp:TemplateField  ItemStyle-HorizontalAlign="Center" >
											<ItemTemplate>
												<a id="linkDown" href= "Download.ashx?file=images/cat1.jpg">
													...
													CommandName="SubeCarga" ToolTip="Descarga el fichero" Width="30px" Height="30px"></asp:ImageButton>
												</a>
									...
									<asp:TemplateField HeaderText="Directorio" Visible="false" SortExpression="ZDIRECTORIO">
										<EditItemTemplate>
												<asp:TextBox ID="TabDirectorio" runat="server" Visible="false" Text='<%# Eval("ZDIRECTORIO") %>' class="gridListAinput"></asp:TextBox>
										</EditItemTemplate>
										<ItemTemplate>
												<asp:Label ID="LabLLDirectorio" runat="server" Visible="false" Text='<%# Bind("ZDIRECTORIO") %>'></asp:Label>
										</ItemTemplate>
									</asp:TemplateField>
                        ...
                        <div id="DivGridDoc" visible="false" runat="server" style=" height:180px;overflow:auto;" class="col-lg-10"> <%-- AutoGenerateSelectButton="True"--%>                                  
							<br />
                            <asp:GridView ID="gvLista"  runat="server" AutoGenerateColumns="False" class="table table-striped table-bordered table-condensed table-responsive table-hover " 
                                ...
                                CellPadding="4"  GridLines="None"  OnRowDataBound="gvLista_OnRowDataBound"  width="100%" AllowPaging="True" PageSize="100" OnRowCommand="gvLista_RowCommand" DataKeyNames="ZID"
						...
						<div id="AutoFile" runat="server" visible="true" class="col-lg-2" style="margin-top: 15px;" >
							<asp:Label ID="Label3" Visible="true" runat="server" Text="Fichero: "></asp:Label>
							<input id="File1" type="file" class="file-select"  runat="server" />
							<br />
							<asp:Button ID="btnEnviar" Visible="true" style="width: 100%;" class="btn btn-info btn-block" runat="server" tooltip="Sube el fichero que tienes seleccionado en 'Seleccionar Archivo'" Text="Enviar" OnClick="btnEnviar_Click" />
							<br />
							<asp:Button id="BtRegistraFiles" Visible="true" style="width: 100%;" runat="server" class="btn btn-success"  tooltip="Inserta los ficheros subidos en la documentación adjunta del Registro" Text="Registrar Ficheros" OnClick="BtnActualizar_click" />
						</div>


						<%--<div id="AutoFile" runat="server" visible="true" class="col-lg-4" style="margin-top: 15px;" >
					...
					<div class="row" id="DivUpload" visible="false" runat="server">
						<h3 id="H12" runat="server" style="text-align:center;font-size:16pt;" visible="true"> Herramientas </h3>

                        <br />
						<div class="panel-body">
							<div class="row" id="DivHerramienta" visible="true" runat="server">
								<div class="col-lg-1" style="text-align:right;">
									<a id="linkDown" href= "#">
										<asp:ImageButton ImageUrl="~/Images/hiperlink-blue.png"  runat="server"       
											ToolTip="inserta el Hipervinculo, ruta o fichero en la Web como un Documento adjunto más del Registro" OnClick="btnInsertLink_Click" Width="30px" Height="30px"></asp:ImageButton>
									</a>
								</div>
								<div class="col-lg-2">
									<asp:TextBox id="TextNombre" runat="server" Visible="true" style="width:100%;border-style:none;background-color:#ffffff;"  class="form-control" placeholder="Escribe aqui una descripción del link"></asp:TextBox>
								</div>
								<div class="col-lg-8">
										<asp:TextBox id="TxtLink" runat="server" Visible="true" style="width:100%;border-style:none;background-color:#ffffff;"  class="form-control" placeholder="Puedes añadir un acceso directo como fichero, introduciendo una ruta o link de enlace en esta casilla y pulsando sobre el icono del hipervinculo situado a la izquierda"></asp:TextBox>
								</div>						
							</div>
							<br />
							<div class="row" id="Div1" visible="true" runat="server">
								 <div class="col-lg-1" style="text-align:right;">
									<%--<button id="BtdirecDoc" type="button" runat="server" visible="true" style=" border-style:none; width:25px; height:30px; background-color:transparent;" class="text-muted "  onserverClick="BtnSubDir_Click"><i title="Sube una estructura de directorios como Documentos" class="fa fa-plus-square fa-2x"></i></button>--%>
								 </div>
								<div class="col-lg-3" style="text-align:left;"> 
									<button id="BtdirecDoc" type="button" runat="server" visible="true" class="btn btn-success"  tooltip="Sube una Estructura de Directorios como Documentos Adjuntos"  onserverClick="BtnSubDir_Click">Subir Estructura</button>
								</div>
								<div class="col-lg-1" style="text-align:right;">
									<asp:Label runat="server" Style="color:black ;"  ID="Label4" visible="false" tooltip="Los ficheros a subir son dependientes de la Carpeta seleccionada"  BorderStyle="None" border="0" Width="70%" Text="Dependiente de:"  />
									<button id="BtInsertCategoria" type="button" runat="server" visible="false" style=" border-style:none; width:25px; height:30px; background-color:transparent;" class="text-muted "  onserverClick="BtnewCategoria_Click"><i title="Muestra la casilla para crear Carpeta" class="fa fa-share fa-2x"></i></button>
									<button id="BtnCategoria" type="button" runat="server" visible="false" style=" border-style:none; width:25px; height:30px; background-color:transparent;" class="text-muted "  onserverClick="BtnCategoria_Click"><i title="Añade la nueva Carpeta a la lista de 'Dependiente de'" class="fa fa-plus-square fa-2x"></i></button>
								</div>
								<div class="col-lg-1">
									<asp:DropDownList id="DrDependienteDe" visible="false" runat="server" tooltip="Seleccione la Carpeta de los documentos" Width="100%" CssClass="form-control" AppendDataBoundItems="true" AutoPostBack="True" OnSelectedIndexChanged="DrCategoria_SelectedIndexChanged" />
									<asp:TextBox id="TxtNuevaCat" runat="server" Visible="false" style="width:70%;border-style:none;background-color:#ffffff;" tooltip="Si es Carpeta raiz, seleccione previamente en 'Dependiente de': Ninguno"  class="form-control" placeholder="Nueva Carpeta"></asp:TextBox>
								</div>					
								<div class="col-lg-1">
									<button id="BtnUp" type="button" runat="server" visible="true"  style="text-align:right; border-style:none; background-color:transparent;" class="pull-center text-muted "  onserverClick="BtnCierraUp_click"><i title="Cierra la vista de documentación adjunta" class="fa fa-th fa-3x"></i></button>
								</div>
								<div class="col-lg-1">
									<%--<asp:Label runat="server" Visible="true" Style="color:black ;" tooltip="Introduzca el nombre de la nueva Carpeta"  ID="Label3" BorderStyle="None" border="0" Width="70%" Text="Carpeta:"  />--%>
								</div>
								<div class="col-lg-1">
									<button id="BtnActualizar" type="button" runat="server" visible="false" style=" border-style:none; background-color:transparent;" class="text-muted "  onserverClick="ActualizaGridDocTemp"><i title="Actualiza Documentos subidos en tu carpeta del Servidor" class="fa fa-refresh fa-2x"></i></button>
									<%--<asp:DropDownList id="DrDirectorio" Visible="true"  runat="server" Width="100%"  CssClass="form-control" AppendDataBoundItems="true" AutoPostBack="True" OnSelectedIndexChanged="DrCategoria_SelectedIndexChanged" />--%>
								</div>	
								<div class="col-lg-3" style="text-align:left;"> 
									<button id="BtnCierraTemp" type="button" runat="server" visible="true" class="btn btn-success"  tooltip="Cierra documentación temporal en el Servidor"  onserverClick="CierraTempFicheros_click">Ver Directorio Temporal de Usuario</button>
								</div>
							</div>
						</div>						
					</div>
...
<%--						 <div runat="server" id="DvPreparado" visible="false"  style=" top:600px; width: 30%;z-index: 1999;-moz-border-radius: 10px;-webkit-border-radius: 10px;border-radius: 10px;border: 0px solid black; box-shadow: inset 0 0 5px 5px rgb(157,157,155);" class="alert alert-grey centrado">
                ...
                <div class="row" style="height:1000px; overflow:auto;">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading" style="font-weight:bold; font-size:18px;font-stretch:unset;" >
                                Importación desde la Tabla seleccionada: 
								<asp:Label  type="text"  Width="100%" style=" font-weight: bold;text-align:left; padding:6px;"  runat="server" ID="Tablaseleccion"  Text="" > </asp:Label>
                            ...
                            <div class="panel-body">                           
							    <div class="row">
                                    ...
                                    <div class="col-sm-1" >
                                         <asp:Label  type="text"  visible="true" Width="100%" style=" font-weight: bold;text-align:center; color:olivedrab ; padding:6px;"  runat="server" ID="lbRowControl"  Text="Registros:" > </asp:Label>
                                    	 <asp:Textbox  type="text" Visible="false"  Width="100%" style=" font-weight: bold;text-align:left; padding:6px;"  runat="server" ID="TextTodo"  Text="" > </asp:Textbox>
									</div>
                                    <div class="col-sm-2" >
                                ...
                                <div class="row">
									...
									<div id="DivTodo" runat="server" visible="false" class="panel-body" style="overflow:auto; height:1000px;"> <%-- style="overflow:auto; height:800px;" AutoGenerateSelectButton="True" DataKeyNames="ZID"--%>  
                                        <asp:Label  type="text" Visible="false"  Width="100%" style=" font-size:72px; font-weight: bold;text-align:center;padding:6px; "  runat="server" ID="Label5" CssClass="centrado"  Text="" ><i class="fa fa-folder" style="color:gold" aria-hidden="true"></i> - Entorno de Trabajo / Directorio virtual </asp:Label>
										<asp:GridView ID="gvControlTodo" Visible="true"  runat="server" AutoGenerateColumns="true" class="table table-striped table-bordered table-condensed table-responsive table-hover " 
                                            AllowSorting="true" OnSorting="gvControlTodo_OnSorting"
                                            CellPadding="4"  GridLines="None"  OnRowDataBound="gvControlTodo_OnRowDataBound"  width="100%" AllowPaging="True" PageSize="15" OnRowCommand="gvControlTodo_RowCommand"  DataKeyNames="NombreColumna"
                                            oonselectedindexchanged="gvControlTodo_SelectedIndexChanged" 
                                            onpageindexchanging="gvControlTodo_PageIndexChanging"  >
                                        <RowStyle />    
                                            <%--Columnas en modo diseño--%>
                                            <Columns>
<%--                                                <asp:CommandField ButtonType="Image" 
                                    ...
                                    <div id="DivGrid" runat="server" visible="false" class="panel-body" style="overflow:auto; height:1000px;"> <%-- style="overflow:auto; height:800px;" AutoGenerateSelectButton="True" DataKeyNames="ZID"--%>  
										...
										<asp:GridView ID="gvControl" Visible="true"  runat="server" AutoGenerateColumns="true" class="table table-striped table-bordered table-condensed table-responsive table-hover " 
                                            ...
                                            oonselectedindexchanged="gvControl_SelectedIndexChanged" 
...
<%--                                                <asp:CommandField ButtonType="Image" 
									...
									<div id="DivGridArchivo" runat="server" visible="false" class="panel-body" style="overflow:auto;"> <%-- style="overflow:auto; height:800px;" AutoGenerateSelectButton="True" DataKeyNames="ZID"--%>  
                                        <asp:GridView ID="gvControlArchivo"  runat="server" AutoGenerateColumns="true" class="table table-striped table-bordered table-condensed table-responsive table-hover " 
                                            ...
                                            oonselectedindexchanged="gvControlArchivo_SelectedIndexChanged" 
