...
<%--									<div class="row" runat="server" id="DivUpFile" visible="true" style="width:100%; height:180px; text-align:left;" >
					...
					<div class="row" >
                      <div class="col-lg-12"  >
                         <div class="bs-example" id="MisMenus" visible="false" runat="server">
                            <ul class="nav nav-tabs" style="margin-bottom: 15px;" >
                                <li id="Menu0" class="active" runat="server" ><asp:LinkButton ID="aMenu0" runat="server" OnClick="HtmlAnchor_Click" >Documentación electrónica asociada</asp:LinkButton></li>                        
                                <li id="Menu1" class="" runat="server" ><asp:LinkButton ID="aMenu1" runat="server" OnClick="HtmlAnchor_Click" >Subida de ficheros</asp:LinkButton></li>
                                <li id="Menu2" class=""  runat="server" ><asp:LinkButton ID="aMenu2" runat="server" OnClick="HtmlAnchor_Click" >Jerarquía Estructura</asp:LinkButton></li>
                           </ul>
                        </div>
                     </div>
                  </div>
					...
					<div class="tab-pane fade active in" visible="false" runat="server" id="BMenu0">
					...
					<div class="tab-pane fade" visible="false" runat="server" id="BMenu1">
						<%-- Upload--%> 
						<div class="row" runat="server" id="DivUp" visible="true" style="width:100%; height:180px;" >
					...
					<div class="tab-pane fade" visible="false" runat="server" id="BMenu2">
						<%-- Treeview--%> 
							<div id="DivDown" visible="true" runat="server" style=" height:180px;overflow:auto;" class="col-lg-8">
								<div class="panel-body">
									<div class="col-lg-6">
										<asp:TreeView ID="TreeMenu" class="tabla1" runat="server" ImageSet="XPFileExplorer" NodeIndent="15" NodeStyle-CssClass="treeNode"
										RootNodeStyle-CssClass="rootNode" LeafNodeStyle-CssClass="leafNode" OnSelectedNodeChanged="TreeMenu_SelectedNodeChanged" >
											<HoverNodeStyle Font-Underline="True" ForeColor="#6666AA" />
											<NodeStyle Font-Names="Tahoma" Font-Size="8pt" ForeColor="Black" HorizontalPadding="2px"
												NodeSpacing="0px" VerticalPadding="2px"></NodeStyle>
											<ParentNodeStyle Font-Bold="False" />
									...
									<div class="col-lg-2">
										<asp:Label runat="server"  class="alert alert-grey" ID="Label5" BorderStyle="None" border="0" Width="100%" Text="Categoría:"  />
									</div>
									<div class="col-lg-2">
										<asp:TextBox id="TxtCategoria" runat="server" Visible="true" style="width:100%;border-style:none;background-color:#ffffff;"  class="form-control" placeholder="Introduce una Categoría y pulsa para generarla en la estructura"></asp:TextBox>
									</div>
									<div class="col-lg-2">
										<button type="button" visible="true" id="BtnAddCategoria" style="width:100%;" runat="server" onServerClick="BtnAddCategoria_click" class="btn btn-primary">Buscar Registros</button>
									</div>
								</div>
							</div>
					</div>
...
<%--                                    <div id="Div2" runat="server" visible="false" style="overflow:auto;" class="panel-body"> <%-- AutoGenerateSelectButton="True"
                                    ...
                                    <div id="DivGrid" runat="server" visible="false" class="panel-body" style="overflow:auto; height:1000px;"> <%-- style="overflow:auto; height:800px;" AutoGenerateSelectButton="True" DataKeyNames="ZID"--%>  
										...
										<asp:GridView ID="gvControl" Visible="true"  runat="server" AutoGenerateColumns="true" class="table table-striped table-bordered table-condensed table-responsive table-hover " 
                                            AllowSorting="true" OnSorting="gvControl_OnSorting" OnRowCreated="gvControl_RowCreated"
...
<%--                                                <asp:CommandField ButtonType="Image" 
									...
									<div id="DivGridArchivo" runat="server" visible="false" class="panel-body" style="overflow:auto;"> <%-- style="overflow:auto; height:800px;" AutoGenerateSelectButton="True" DataKeyNames="ZID"--%>  
                                        <asp:GridView ID="gvControlArchivo"  runat="server" AutoGenerateColumns="true" class="table table-striped table-bordered table-condensed table-responsive table-hover " 
                                            AllowSorting="true" OnSorting="gvControlArchivo_OnSorting" OnRowCreated="gvControlArchivo_RowCreated"
