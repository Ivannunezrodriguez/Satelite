...
//Opcion 1 seguir seguir
//Opcion 2 Eliminar de las llamadas publicitarias de las compañias
//Moneda basada en alimentos
        ...
        protected void gvControlTodo_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
        {
            ...
            try
            {
                ...
                else if (e.CommandName == "BajaOrden")
                {
                    ...
                    //Desglosa Tabla y Columna y busca por el Texto

#pragma warning disable CS0219 // La variable 'AA' está asignada pero su valor nunca se usa
                    int AA = 0;
#pragma warning restore CS0219 // La variable 'AA' está asignada pero su valor nunca se usa
...
#pragma warning disable CS0219 // La variable 'NombreDivCampo' está asignada pero su valor nunca se usa
                    string NombreDivCampo = "";
#pragma warning restore CS0219 // La variable 'NombreDivCampo' está asignada pero su valor nunca se usa
...
#pragma warning restore CS0219 // La variable 'Esta' está asignada pero su valor nunca se usa
                    ...
                    foreach (TableCell cell in row.Cells)
                    {
                        ...
                        if ((AA % 2) == 0)
                        {
                            ...
                            if (NombreCombo.Visible == true)
                            {
                                ...
                                {
                                    if (NombreCombo.Items[i].Value == HTMLaTXT(cell.Text))
                                    {
        ...
        private void PopulateRootLevel()
        {
            ...
            {
                TreeDoc.Nodes.Clear();
                dt = Main.CargaArbolDocumentos(0, Convert.ToInt32((string)Session["MiNivel"]), this.Session["TablaObj"].ToString(),"1");
        ...
        private void Campos_Categoria()
        {
            ...
            DrCategoria.DataValueField = "ZID";
            DrCategoria.DataTextField = "ZDESCRIPCION";

            DataTable dt = new DataTable();
            dt = Main.CargaCategorias().Tables[0];

            DrCategoria.DataSource = dt;
            DrCategoria.DataBind();
        ...
        private void Carga_tablaControl(DataTable dtArchivos, DataTable dtCampos, string sortExpression = null)
        {
            ...
            try
            {
                ...
                foreach (DataRow fila in dtArchivos.Rows)
                {
                    ...
                    string Idvolumen = "";
                    if (fila["ZID_VOLUMEN"].ToString() == "")
                    {
                        Idvolumen = "SELECT ZRUTA FROM ZVOLUMENES WHERE ZID = 0 " ;
                    }
                    else
                    {
                        Idvolumen = "SELECT ZRUTA FROM ZVOLUMENES WHERE ZID = " + fila["ZID_VOLUMEN"].ToString();
                    }
        ...
        private void CreaGridControlArchivo(DataTable dtArchivo, DataTable dtCampo)
        {
            //int i =  Convert.ToInt32(this.Session["NumeroPalet"].ToString());
        ...
        private void CreaGridFiles(string Tablaficheros)
        {
            ...
            try
            {
                ...
                string SQL = " SELECT ZID, ID_DOMAIN, ID_ARCHIVO, NOMBRE, ID_NAME, RUTA, PESO, ROOT, ZKEY, ";
                SQL += " ESTADO, FECHA,CATEGORIA, SUBCATEGORIA, ZUSER ";
